locales['en'] = {
    ...
    ['actions:license:give_remove'] = "Give/Remove licenses",
    ...
    ["boss:employee"] = "%s %s - %s",
    ["boss:fire"] = "Fire",
    ["boss:change_grade"] = "Change grade",
    ...
    ['job_shop_quantity'] = "Quantity - x%d -> $%s",
    ...
    ["input_sprint:letter"] = "SHIFT",
    ["input_attack:letter"] = "LEFT MOUSE",

    ["boss:no_employees"] = "No employees found"
}
