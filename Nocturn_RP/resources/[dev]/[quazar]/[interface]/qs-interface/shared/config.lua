...
Config.UseStress = true                                           -- Enable stress bar in the HUD screen (just enables the stress bar, not the stress system)
...
Config.Units = 'mph'                                                                -- Vehicle speed units ('kmh' or 'mph')
Config.HideRadar = false                                                            -- Hide the minimap when the player is not inside a vehicle
...
--[[
    ...
    Defines personal settings related to the HUD, notifications,
    progress display, and the primary color theme.
]]

Config.Shared.PlayerSettings = {
    Hud = {
        type = 'basic',    -- HUD type
        alignment = 'row', -- HUD alignment
    },
    Notify = {
        type = 'basic',     -- Notification type
        alignment = 'left', -- Notification alignment
        easing = 'linear'   -- Easing type
    },
    Displayers = {
        type = 'basic', -- Displayer type
    },
    Progress = {
        type = 'basic', -- Progress bar type
    },
    Color = '#00B2FF',  -- Main interface color
}
