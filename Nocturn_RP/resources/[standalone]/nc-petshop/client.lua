...
CreateThread(function()
    ...
    BeginTextCommandSetBlipName("STRING")
    AddTextComponentString('Clinique Vétérinaire')
...
AddEventHandler('nc-petshop:removePet', function()
    QBCore.Functions.Notify('Nous avons pris votre animal. Monstre.') 
...
AddEventHandler('nc-petshop:healPet', function()
    ...
    if DoesEntityExist(pet) then
        ...
        QBCore.Functions.Notify('Votre animal est en train d\'être soigné dans l\'autre pièce.')
        Wait(15000)
        stay = false
        ...
        if petHealth < 100 or petSpeed ~= 10.0 then
            if illness == 'fatigue' then
                QBCore.Functions.Notify('Votre animal a été soigné pour ' .. illness)
                SetEntityHealth(pet, 200)
                illness = 'none'
                illnessFee = 100
                petSpeed = 10.0
            elseif illness == 'kennelcough' then
                QBCore.Functions.Notify('Votre animal a été soigné pour la ' .. 'Toux de Chenil')
                illness = 'none'
                SetEntityHealth(pet, 200)
                illnessFee = 300
                petHealth = 100
        ...
        QBCore.Functions.Notify('Où est votre animal ? Je ne peux pas soigner les gens')
    end
end)
...
AddEventHandler('nc-petshop:feedPet', function()
    QBCore.Functions.TriggerCallback("nc-petshop:feedPetCallback", function(result)
        if result then
            ...
            QBCore.Functions.Notify("Vous n'avez pas de nourriture pour animaux. Achetez-en à l'animalerie", "error")
        end
    end)
...
AddEventHandler('nc-petshop:petStore', function()
    local petMenu = {{
        ...
        txt = "Acheter de la nourriture" .. " pour $" .. Config.FoodPrice,
        params = {
    ...
    },
    {
        ...
        txt = "Acheter une balle" .. " pour $" .. Config.TennisBallPrice,
        params = {
            event = 'nc-petshop:buyTennisBall'
        }
    }, {
        header = "Achat #1",
        txt = Config.Pet1Label .. " pour $" .. Config.Pet1Price,
        params = {
            event = 'nc-petshop:buyPet1'
        }
    }, {
        header = "Achat #2",
        txt = Config.Pet2Label .. " pour $" .. Config.Pet2Price,
        params = {
            event = 'nc-petshop:buyPet2'
        }
    }, {
        header = "Achat #3",
        txt = Config.Pet3Label .. " pour $" .. Config.Pet3Price,
        params = {
            event = 'nc-petshop:buyPet3'
        }
    }, {
        header = "Achat #4",
        txt = Config.Pet4Label .. " pour $" .. Config.Pet4Price,
        params = {
            event = 'nc-petshop:buyPet4'
        }
    }, {
        header = "Achat #5",
        txt = Config.Pet5Label .. " pour $" .. Config.Pet5Price,
        params = {
            event = 'nc-petshop:buyPet5'
        }
    }, {
        header = "Achat #6",
        txt = Config.Pet6Label .. " pour $" .. Config.Pet6Price,
        params = {
            event = 'nc-petshop:buyPet6'
        }
    }, {
        header = "Achat #7",
        txt = Config.Pet7Label .. " pour $" .. Config.Pet7Price,
        params = {
            event = 'nc-petshop:buyPet7'
        }
    }, {
        header = "Achat #8",
        txt = Config.Pet8Label .. " pour $" .. Config.Pet8Price,
        params = {
            event = 'nc-petshop:buyPet8'
        }
    }, {
        header = "Achat #9",
        txt = Config.Pet9Label .. " pour $" .. Config.Pet9Price,
        params = {
            event = 'nc-petshop:buyPet9'
        }
    }, {
        header = "Achat #10",
        txt = Config.Pet10Label .. " pour $" .. Config.Pet10Price,
        params = {
            event = 'nc-petshop:buyPet10'
        }
    }, {
        header = "Achat #11",
        txt = Config.Pet11Label .. " pour $" .. Config.Pet11Price,
        params = {
