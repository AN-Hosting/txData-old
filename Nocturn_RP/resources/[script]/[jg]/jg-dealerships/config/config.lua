...
Config.FuelSystem = "none" -- or "cdn-fuel", "ps-fuel", "lj-fuel", "ox_fuel", "cdn-fuel", "hyon_gas_station", "okokGasStation", "nd_fuel", "myFuel", "ti_fuel", "Renewed-Fuel", "rcore_fuel", "qs-fuelstations", "none"
...
-- Test drives
Config.TestDrivePlate = "NOCTURN" -- This is a plate seed so it'll be random every time (read: https://docs.jgscripts.com/dealerships/plate-format)
...
Config.DisplayVehiclesPlate = "VENDRE"
...
Config.VehicleColourOptions = {
  {label = "Rouge", hex = "#e81416", index = 27},
  {label = "Rouge Torino", hex = "#FF0000", index = 28},
  {label = "Rouge Formule", hex = "#B22222", index = 29},
  {label = "Rouge Flamme", hex = "#FF3300", index = 30},
  {label = "Rouge Grâce", hex = "#8B0000", index = 31},
  {label = "Orange", hex = "#ff7518", index = 38},
  {label = "Orange Vif", hex = "#FF4500", index = 138},
  {label = "Jaune", hex = "#ffbf00", index = 88},
  {label = "Jaune Course", hex = "#FFD700", index = 89},
  {label = "Vert", hex = "#79c314", index = 92},
  {label = "Vert Course", hex = "#004225", index = 50},
  {label = "Vert Océan", hex = "#2E8B57", index = 51},
  {label = "Vert Olive", hex = "#556B2F", index = 52},
  {label = "Bleu", hex = "#487de7", index = 64},
  {label = "Bleu Galaxie", hex = "#000080", index = 61},
  {label = "Bleu Foncé", hex = "#00008B", index = 62},
  {label = "Bleu Nuit", hex = "#191970", index = 141},
  {label = "Violet", hex = "#70369d", index = 145},
  {label = "Violet Nuit", hex = "#2E0854", index = 142},
  {label = "Noir", hex = "#000000", index = 0},
  {label = "Noir Carbone", hex = "#1B1B1B", index = 147},
  {label = "Graphite", hex = "#383838", index = 1},
  {label = "Blanc", hex = "#ffffff", index = 111},
  {label = "Blanc Givré", hex = "#F0FFFF", index = 112},
  {label = "Crème", hex = "#FFFDD0", index = 107},
  {label = "Argent", hex = "#C0C0C0", index = 4},
  {label = "Rose Vif", hex = "#FF69B4", index = 135},
  {label = "Or", hex = "#FFD700", index = 99},
}
