...
RegisterNetEvent('QBCore:Player:SetPlayerData', function(val)
    Wait(250) -- May have to increase this to 500 or 1000 so the core/invent can catch up, you also may want to throw out qs-inventory and just get ox_inventory...
