...
Config.ServerName = 'Nocturn RP'       -- Server shortname for pause menu
...
Config.StealDeadPlayer = false      -- Allows players to loot items from dead players when enabled.
...
Config.OpenInventoryAnim = false -- Enables a player animation when opening the inventory
...
Config.DiscordLink = 'https://discord.gg/Fxjrm3HWds'       -- Discord Link
