...
Config.Products = {
    ...
    ['weapons'] = {
        ...
        { name = 'pistol_ammo',          price = 250,  amount = 250, requiredLicense = 'weaponlicense' },
        { name = 'weapon_pistol',        price = 2500, amount = 5,   requiredLicense = 'weaponlicense' },
        { name = 'weapon_snspistol',     price = 1500, amount = 5,   requiredLicense = 'weaponlicense' },
        { name = 'weapon_vintagepistol', price = 4000, amount = 5,   requiredLicense = 'weaponlicense' },
    },
    ['blackmarket'] = {
