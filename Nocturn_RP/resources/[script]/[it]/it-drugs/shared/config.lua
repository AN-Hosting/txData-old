...
Config.Language = 'fr' -- Choose your language from the locales folder
...
Config.ClearOnStartup = false -- Clear dead plants on script start-up
...
Config.ItemToDestroyPlant = true -- true to need an item to destroy a plant
...
Config.SellEverywhere = {
    ...
    drugs = {
        ['cocaine'] = {price = math.random(100, 200), moneyType = 'cash'}, -- bank
