...
Config.Harness = {
    ...
    diableCrashEjection = true,    -- If true, disable crash ejection
...
Config.vehFailure = {
    ...
    oldPreventRoll = false,              -- if this is enabled, the rolling will be prevented with disabling keys
                                        -- if false, the rolling will be prevented by altering the gravity of the vehicle
