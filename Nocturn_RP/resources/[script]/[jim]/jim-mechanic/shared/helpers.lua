...
Helper.getTrimmedPlate = function(vehicle)
	-- Fakeplate stuff can go here
	-- This function is used as a wrapper to trim the plate, but you could use this to check if a plate is faked
	-- if you have a script that controls this,
