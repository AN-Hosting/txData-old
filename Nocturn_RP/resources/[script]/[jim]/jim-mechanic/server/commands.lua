...
onResourceStart(function()
	...
	registerCommand("hood", { locale("serverFunctions", "toggleHood"), {}, false, function(source) TriggerClientEvent(getScript()..":client:openDoor", source, 4) end })
	registerCommand("trunk", { locale("serverFunctions", "toggleTrunk"), {}, false, function(source) TriggerClientEvent(getScript()..":client:openDoor", source, 5) end })
	registerCommand("door", { locale("serverFunctions", "toggleDoor"), {{name="0-3", help="Door ID"}}, false, function(source, args) TriggerClientEvent(getScript()..":client:openDoor", source, args[1]) end })
