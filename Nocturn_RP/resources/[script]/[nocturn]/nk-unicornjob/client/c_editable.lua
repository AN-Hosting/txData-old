...
RegisterNetEvent('nk-unicornjob:client:Eat', function(itemName)
    ...
    QBCore.Functions.Progressbar("eat_something", Language.Progressbars.Eating..QBCore.Shared.Items[itemName].label.."..", 5000, false, true, {
        ...
        TriggerServerEvent("nk-unicornjob:Server:RemoveItem", itemName, 1)
...
RegisterNetEvent('nk-unicornjob:client:Drink', function(itemName)
...
RegisterNetEvent('nk-unicornjob:client:DrinkAlcahol', function(itemName)
