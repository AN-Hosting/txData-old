...
Strings = {
    ...
    ['bowling_info'] = '~INPUT_CELLPHONE_LEFT~ ~INPUT_CELLPHONE_RIGHT~ Rotation\n~INPUT_CELLPHONE_UP~ ~INPUT_CELLPHONE_DOWN~ Changer la force\n~INPUT_MOVE_LEFT_ONLY~ ~INPUT_MOVE_RIGHT_ONLY~ Changer de caméra\n~INPUT_ATTACK~ Lancer\n~INPUT_FRONTEND_RRIGHT~ Arrêter de jouer',
    ['force'] = 'Puissance: %s',
    ['strike'] = {'FÉLICITATIONS, C\'EST LA FÊTE', 'VOUS AVEZ FAIT UN STRIKE!!'},
    ['spare'] = {'Bowling', 'Bien joué! Vous avez fait un spare'},
    ['x_pinsdown'] = {'Bowling', 'Vous avez fait tomber %s quilles sur %s'},
    ['this_occupied'] = 'Cette piste de bowling est occupée.',
    ['every_occupied'] = 'Toutes les pistes de bowling sont occupées.',
    ['blip'] = 'Activité: Bowling'
}