...
function progressBar(data)
    local danim = { dict = data.dict or false, flag = data.flag or 49}
    return exports.ox_lib:progressBar({ label = data.label, duration = data.time, canCancel = data.cancel, anim = danim })
end
...
CreateThread(function()
	...
	if Config.Locations[1].zoneEnable then	-- [[ Main Location ]] --
        ...
        --[[if loc.MLO == "NP" then
			...
			--Stash/Shops
			Targets["BShelf"] =
			exports['qb-target']:AddBoxZone("BShelf", vec3(-1202.76, -896.65, 13.89), 3.0, 1.0, { name="BShelf", heading = 35.0, debugPoly=Config.Debug, minZ = 10.89, maxZ = 14.89, },
				{ options = { { event = "jim-burgershot:Stash", icon = "fas fa-box-open", label = Loc[Config.Lan].targetinfo["open_shelves"], job = Config.Locations[1].job, id = "BSShelf", coords = vec3(-1195.29, -897.51, 13.97) }, },
					distance = 2.0 })
			Targets["BFridge"] =
			exports['qb-target']:AddBoxZone("BFridge", vec3(-1196.39, -901.17, 13.89), 3.8, 0.6, { name="BFridge", heading = 255.0, debugPoly=Config.Debug, minZ = 10.89, maxZ = 14.89, },
			...
			Targets["BStore"] =
			exports['qb-target']:AddBoxZone("BStore", vec3(-1196.08, -902.34, 13.89), 0.4, 1.4, { name="BStore", heading = 35, debugPoly=Config.Debug, minZ = 10.89, maxZ = 14.89, },
				{ options = { { event = "jim-burgershot:Shop", icon = "fas fa-temperature-low", label = Loc[Config.Lan].targetinfo["open_storage"], job = Config.Locations[1].job, id = "BSShop", shop = Config.Items, coords = vec3(-1198.5, -904.02, 13.97) }, },
					distance = 1.5 })
			Targets["BBag"] =
			exports['qb-target']:AddBoxZone("BBag", vec3(-1197.56, -896.7, 13.89), 0.4, 1.4, { name="BBag", heading = 345.0, debugPoly=Config.Debug, minZ = 10.89, maxZ = 14.89, },
			...
			--Food Making
			Targets["BGrill"] =
			exports['qb-target']:AddBoxZone("BGrill", vec3(-1194.97, -897.51, 14.91-1), 0.7, 1.2, { name="BGrill", heading = 345.0, debugPoly=Config.Debug, minZ = 10.89, maxZ = 14.89, },
				{ options = { { event = "jim-burgershot:Crafting", icon = "fas fa-fire", label = Loc[Config.Lan].targetinfo["use_grill"], job = Config.Locations[1].job, craftable = Crafting.Grill, header = Loc[Config.Lan].menu["grill"], coords = vec3(-1195.37, -898.24, 13.89) }, },
					distance = 2.5 })
			Targets["BFryer"] =
			exports['qb-target']:AddBoxZone("BFryer", vec3(-1195.78, -900.18, 13.83-1), 0.6, 1.6, { name="BFryer", heading = 345.0, debugPoly=Config.Debug, minZ = 10.89, maxZ = 14.89, },
				{ options = { { event = "jim-burgershot:Crafting", icon = "fas fa-temperature-high", label = Loc[Config.Lan].targetinfo["use_deepfryer"], job = Config.Locations[1].job, craftable = Crafting.Fryer, header = Loc[Config.Lan].menu["deep_fat_fryer"], coords = vec3(-1195.72, -899.38, 13.89) }, },
					distance = 1.5 })
			Targets["BChop"] =
			exports['qb-target']:AddBoxZone("BChop", vec3(-1200.85, -894.89, 14.8-1), 0.6, 1.5, { name="BChop", heading = 305.0, debugPoly=Config.Debug, minZ = 10.89, maxZ = 14.89, },
				{ options = { { event = "jim-burgershot:Crafting", icon = "fas fa-utensils", label = Loc[Config.Lan].targetinfo["use_chopping_board"], job = Config.Locations[1].job, craftable = Crafting.ChopBoard, header = Loc[Config.Lan].menu["chopping_board"], coords = vec3(-1200.29, -894.63, 13.89) }, },
					distance = 1.5 })
			Targets["BPrepare"] =
			exports['qb-target']:AddBoxZone("BPrepare", vec3(-1193.56, -897.95, 15.01-1), 0.6, 1.5, { name="BPrepare", heading = 345.0, debugPoly=Config.Debug, minZ = 10.89, maxZ = 14.89, },
				{ options = { { event = "jim-burgershot:Crafting", icon = "fas fa-hamburger", label = Loc[Config.Lan].targetinfo["prepare_food"], job = Config.Locations[1].job, craftable = Crafting.Prepare, header = Loc[Config.Lan].menu["prepare_food"], coords = vec3(-1193.9, -898.57, 13.89) }, },
					distance = 1.5 })
			Targets["BDrink"] =
			exports['qb-target']:AddBoxZone("BDrink", vec3(-1191.22, -898.59, 13.89), 2.0, 0.6, { name="BDrink", heading = 305.0, debugPoly=Config.Debug, minZ = 11.09, maxZ = 15.09, },
				{ options = { { event = "jim-burgershot:Crafting", icon = "fas fa-mug-hot", label = Loc[Config.Lan].targetinfo["prepare_drinks"], job = Config.Locations[1].job, craftable = Crafting.Drink, header = Loc[Config.Lan].menu["drinks_dispenser"], coords = vec3(-1197.25, -894.48, 13.97) }, },
					distance = 1.5 })
			Targets["BDonut"] =
			exports['qb-target']:AddBoxZone("BDonut", vec3(-1200.55, -896.81, 14.8), 0.8, 0.6, { name="BDonut", heading = 300.0, debugPoly=Config.Debug, minZ = 11.8, maxZ = 15.8, },
				{ options = { { event = "jim-burgershot:Crafting", icon = "fas fa-dot-circle", label = Loc[Config.Lan].targetinfo["open_cabinet"], job = Config.Locations[1].job, craftable = Crafting.Donut, header = Loc[Config.Lan].menu["food_cabinet"], coords = vec3(-1200.17, -897.2, 13.89) }, },
					distance = 1.5 })

			--Trays
			Targets["BTray1"] =
			exports['qb-target']:AddBoxZone("BTray1", vec3(-1194.63, -893.21, 13.89-1), 0.6, 1.0, { name="BTray1", heading = 345.0, debugPoly=Config.Debug, minZ = 10.89, maxZ = 14.89, },
			...
			{ options = { { event = "jim-payments:client:Charge", icon = "fas fa-credit-card", label = Loc[Config.Lan].targetinfo["charge_customer"], job = Config.Locations[1].job,
					...
					distance = 1.5 })
			Targets["BReceipt2"] =
			exports['qb-target']:AddCircleZone("BReceipt2", vec3(-1193.97+1, -894.67, 14.15), 0.5, { name="BReceipt2", debugPoly=Config.Debug, useZ=true, },
			{ options = { { event = "jim-payments:client:Charge", icon = "fas fa-credit-card", label = Loc[Config.Lan].targetinfo["charge_customer"], job = Config.Locations[1].job,
							img = "<center><p><img src=https://static.wikia.nocookie.net/gtawiki/images/b/bf/BurgerShot-HDLogo.svg width=225px></p>" }, },
					distance = 1.5 })
			-- Targets["BReceipt3"] =
			...
			-- 		distance = 1.5 })
			Targets["BClockin"] =
			exports['qb-target']:AddBoxZone("BClockin", vec3(-1198.65, -904.49, 13.89-0.5), 0.6, 0.6, { name="BClockin", heading = 305.0, debugPoly=Config.Debug, minZ = 10.89, maxZ = 14.89, },
		...
		elseif loc.MLO == "Gabz" then
			propTable[#propTable+1] = { prop = "prop_food_bs_tray_03", coords = vec4(-1190.85, -896.53, 13.8, 33.36) }
			propTable[#propTable+1] = { prop = "prop_food_bs_tray_02", coords = vec4(-1189.22, -895.42, 13.8, 34.37) }
			propTable[#propTable+1] = { prop = "prop_food_bs_tray_01", coords = vec4(-1194.14, -906.26, 13.91, 350.04) }
			...
			--Stash/Shops
			Targets["BShelf1"] =
			exports['qb-target']:AddBoxZone("BShelf1", vec3(-1187.66, -897.04, 13.8), 1.0, 1.4, { name="BShelf1", heading = 35.0, debugPoly=Config.Debug, minZ = 13.7, maxZ = 14.77, },
				{ options = { { event = "jim-burgershot:Stash", icon = "fas fa-box-open", label = Loc[Config.Lan].targetinfo["open_shelves"], job = Config.Locations[1].job, id = "BSShelf1", coords = vec3(-1195.29, -897.51, 13.97) }, },
					distance = 2.0 })
			Targets["BShelf2"] =
			exports['qb-target']:AddBoxZone("BShelf2", vec3(-1191.25, -903.9, 13.8), 1.5, 1.0, { name="BShelf2", heading = 35.0, debugPoly=Config.Debug, minZ = 12.7, maxZ = 15.3, },
				{ options = { { event = "jim-burgershot:Stash", icon = "fas fa-box-open", label = Loc[Config.Lan].targetinfo["open_shelves"], job = Config.Locations[1].job, id = "BSShelf2", coords = vec3(-1195.29, -897.51, 13.97) }, },
					distance = 2.0 })
			Targets["BFridge"] =
			exports['qb-target']:AddBoxZone("BFridge", vec3(-1183.45, -900.56, 13.8), 0.5, 2.5, { name="BFridge", heading = 35.0, debugPoly=Config.Debug, minZ = 13.0, maxZ = 15.0, },
				{ options = { { event = "jim-burgershot:Stash", icon = "fas fa-temperature-low", label = Loc[Config.Lan].targetinfo["open_fridge"], job = Config.Locations[1].job, id = "BSFridge", coords = vec3(-1201.31, -901.69, 13.97) }, },
					distance = 1.5 })

			Targets["BStore"] =
			exports['qb-target']:AddBoxZone("BStore", vec3(-1192.23, -898.29, 13.8), 2.0, 0.5, { name="BStore", heading = 213.65, debugPoly=Config.Debug, minZ = 12.97, maxZ = 15.37, },
				{ options = { { event = "jim-burgershot:Shop", icon = "fas fa-temperature-low", label = Loc[Config.Lan].targetinfo["open_storage"], job = Config.Locations[1].job, id = "BSShop", shop = Config.Items, coords = vec3(-1198.5, -904.02, 13.97) }, },
					distance = 1.5 })
			Targets["BBag"] =
			exports['qb-target']:AddBoxZone("BBag", vec3(-1188.71, -897.78, 13.8), 0.9, 0.5, { name="BBag", heading = 305.0, debugPoly=Config.Debug, minZ = 13.97, maxZ = 14.57, },
				{ options = { { event = "jim-burgershot:client:GrabBag", icon = "fas fa-bag-shopping", label = Loc[Config.Lan].targetinfo["grab_murderbag"], job = Config.Locations[1].job, }, },
					distance = 2.0 })

			--Food Making
			Targets["BGrill"] =
			exports['qb-target']:AddBoxZone("BGrill", vec3(-1186.85, -900.56, 13.8), 0.9, 1.4, { name="BGrill", heading = 34.93, debugPoly=Config.Debug, minZ = 13.3, maxZ = 14.5, },
				{ options = { { event = "jim-burgershot:Crafting", icon = "fas fa-fire", label = Loc[Config.Lan].targetinfo["use_grill"], job = Config.Locations[1].job, craftable = Crafting.Grill, header = Loc[Config.Lan].menu["grill"], coords = vec3(-1198.27, -895.3, 14.0) }, },
					distance = 1.5 })
			Targets["BFryer"] =
			exports['qb-target']:AddBoxZone("BFryer", vec3(-1187.28, -899.67, 13.8), 1.0, 1.5, { name="BFryer", heading = 218.22, debugPoly=Config.Debug, minZ = 12.97, maxZ = 14.57, },
				{ options = { { event = "jim-burgershot:Crafting", icon = "fas fa-temperature-high", label = Loc[Config.Lan].targetinfo["use_deepfryer"], job = Config.Locations[1].job, craftable = Crafting.Fryer, header = Loc[Config.Lan].menu["deep_fat_fryer"], coords = vec3(-1200.85, -896.84, 13.97) }, },
					distance = 1.5 })
			Targets["BChop"] =
			exports['qb-target']:AddBoxZone("BChop", vec3(-1188.52, -904.03, 13.8), 1.0, 1.0, { name="BChop", heading = 213.93, debugPoly=Config.Debug, minZ = 13.3, maxZ = 14.5, },
				{ options = { { event = "jim-burgershot:Crafting", icon = "fas fa-utensils", label = Loc[Config.Lan].targetinfo["use_chopping_board"], job = Config.Locations[1].job, craftable = Crafting.ChopBoard, header = Loc[Config.Lan].menu["chopping_board"], coords = vec3(-1197.19, -898.18, 14.0) }, },
					distance = 1.5 })
			Targets["BPrepare"] =
			exports['qb-target']:AddBoxZone("BPrepare", vec3(-1188.17, -900.8, 13.8), 1.5, 1.0, { name="BPrepare", heading = 34.93, debugPoly=Config.Debug, minZ = 13.3, maxZ = 14.5, },
				{ options = { { event = "jim-burgershot:Crafting", icon = "fas fa-hamburger", label = Loc[Config.Lan].targetinfo["prepare_food"], job = Config.Locations[1].job, craftable = Crafting.Prepare, header = Loc[Config.Lan].menu["prepare_food"], coords = vec3(-1196.54, -899.28, 13.98) }, },
					distance = 1.5 })
			Targets["BDrink1"] =
			exports['qb-target']:AddBoxZone("BDrink1", vec3(-1191.45, -897.99, 13.8), 2.0, 0.6, { name="BDrink1", heading = 35.0, debugPoly=Config.Debug, minZ = 13.97, maxZ = 14.97, },
				{ options = { { event = "jim-burgershot:Crafting", icon = "fas fa-mug-hot", label = Loc[Config.Lan].targetinfo["prepare_drinks"], job = Config.Locations[1].job, craftable = Crafting.Drink, header = Loc[Config.Lan].menu["drinks_dispenser"], coords = vec3(-1197.25, -894.48, 13.97) }, },
					distance = 1.5 })
			Targets["BDrink2"] =
			exports['qb-target']:AddBoxZone("BDrink2", vec3(-1191.26, -905.48, 13.8), 1.0, 1.5, { name="BDrink2", heading = 35.0, debugPoly=Config.Debug, minZ = 13.97, maxZ = 14.97, },
				{ options = { { event = "jim-burgershot:Crafting", icon = "fas fa-mug-hot", label = Loc[Config.Lan].targetinfo["prepare_drinks"], job = Config.Locations[1].job, craftable = Crafting.Drink, header = Loc[Config.Lan].menu["drinks_dispenser"], coords = vec3(-1197.25, -894.48, 13.97) }, },
					distance = 1.5 })
			Targets["BDonut"] =
			exports['qb-target']:AddBoxZone("BDonut", vec3(-1189.76, -898.28, 13.8), 0.8, 0.9, { name="BDonut", heading = 35.0, debugPoly=Config.Debug, minZ = 12.97, maxZ = 14.00, },
			...
			--Trays
			Targets["BTray1"] =
			exports['qb-target']:AddBoxZone("BTray1", vec3(-1191.39, -896.16, 14.04), 0.6, 1.0, { name="BTray1", heading = 215.0, debugPoly=Config.Debug, minZ = 13.5, maxZ = 14.8, },
				{ options = { { event = "jim-burgershot:Stash", icon = "fas fa-hamburger", label = Loc[Config.Lan].targetinfo["open_tray"], id = "BSTray1" }, },
					distance = 2.0 })

			Targets["BTray2"] =
			exports['qb-target']:AddBoxZone("BTray2", vec3(-1188.26, -894.13, 13.8), 0.6, 1.0, { name="BTray2", heading = 215.0, debugPoly=Config.Debug, minZ = 13.5, maxZ = 14.8, },
				{ options = { { event = "jim-burgershot:Stash", icon = "fas fa-hamburger", label = Loc[Config.Lan].targetinfo["open_tray"], id = "BSTray2" }, },
					distance = 2.0 })

			Targets["BTray4"] =
			exports['qb-target']:AddBoxZone("BTray4", vec3(-1189.79, -895.07, 14.04), 0.6, 1.0, { name="BTray4", heading = 215.0, debugPoly=Config.Debug, minZ = 13.5, maxZ = 14.8, },
				{ options = { { event = "jim-burgershot:Stash", icon = "fas fa-hamburger", label = Loc[Config.Lan].targetinfo["open_tray"], id = "BTray4" }, },
					distance = 2.0 })


			Targets["BTray3"] =
			exports['qb-target']:AddBoxZone("BTray3", vec3(-1193.88, -905.73, 13.91), 0.6, 1.4, { name="BTray3", heading = 355.0, debugPoly=Config.Debug, minZ = 13.5, maxZ = 14.8, },
				{ options = { { event = "jim-burgershot:Stash", icon = "fas fa-hamburger", label = Loc[Config.Lan].targetinfo["open_tray"], id = "BSTray3" }, },
					distance = 5.0 })

			--Hand Washing
			Targets["BWash"] =
			exports['qb-target']:AddBoxZone("BWash1", vector3(-1186.55, -903.32, 14.75), 0.6, 0.8, { name="BWash1", heading = 300.0, debugPoly=Config.Debug, minZ = 13.3, maxZ = 14.5, },
				{ options = { { event = "jim-burgershot:washHands", icon = "fas fa-hand-holding-water", label = Loc[Config.Lan].targetinfo["wash_hands"], }, },
					distance = 2.0 })

			--Payments / Clockin
			Targets["BReceipt"] =
			exports['qb-target']:AddCircleZone("BReceipt", vec3(-1194.68, -905.00, 13.8), 0.5, { name="BReceipt", debugPoly=Config.Debug, useZ=true, },
			{ options = { { event = "jim-payments:client:Charge", icon = "fas fa-credit-card", label = Loc[Config.Lan].targetinfo["charge_customer"], job = Config.Locations[1].job,
							img = "<center><p><img src=https://static.wikia.nocookie.net/gtawiki/images/b/bf/BurgerShot-HDLogo.svg width=225px></p>" }, },
					distance = 1.5 })
			Targets["BReceipt2"] =
			exports['qb-target']:AddCircleZone("BReceipt2", vec3(-1189.1, -894.7, 13.8), 0.5, { name="BReceipt2", debugPoly=Config.Debug, useZ=true, },
			{ options = { { event = "jim-payments:client:Charge", icon = "fas fa-credit-card", label = Loc[Config.Lan].targetinfo["charge_customer"], job = Config.Locations[1].job,
							img = "<center><p><img src=https://static.wikia.nocookie.net/gtawiki/images/b/bf/BurgerShot-HDLogo.svg width=225px></p>" }, },
					distance = 1.5 })
			Targets["BReceipt3"] =
			exports['qb-target']:AddCircleZone("BReceipt3", vec3(-1190.35, -895.65, 13.8), 0.5, { name="BReceipt3", debugPoly=Config.Debug, useZ=true, },
			{ options = { { event = "jim-payments:client:Charge", icon = "fas fa-credit-card", label = Loc[Config.Lan].targetinfo["charge_customer"], job = Config.Locations[1].job,
							img = "<center><p><img src=https://static.wikia.nocookie.net/gtawiki/images/b/bf/BurgerShot-HDLogo.svg width=225px></p>" }, },
					distance = 1.5 })
			Targets["BReceipt4"] =
			exports['qb-target']:AddCircleZone("BReceipt4", vec3(-1187.6, -893.6, 13.8), 0.5, { name="BReceipt4", debugPoly=Config.Debug, useZ=true, },
			{ options = { { event = "jim-payments:client:Charge", icon = "fas fa-credit-card", label = Loc[Config.Lan].targetinfo["charge_customer"], job = Config.Locations[1].job,
							img = "<center><p><img src=https://static.wikia.nocookie.net/gtawiki/images/b/bf/BurgerShot-HDLogo.svg width=225px></p>" }, },
					distance = 1.5 })
			Targets["BClockin"] =
			exports['qb-target']:AddBoxZone("BClockin", vec3(-1177.79, -897.49, 14.0), 0.26, 1.2, { name="BClockin", heading = 215.0, debugPoly=Config.Debug, minZ = 13.67, maxZ = 14.77, },
					{ options = { { type = "server", event = "QBCore:ToggleDuty", icon = "fas fa-user-check", label = Loc[Config.Lan].targetinfo["toggle_duty"], job = Config.Locations[1].job },
								{ event = "qb-bossmenu:client:OpenMenu", icon = "fas fa-list", label = Loc[Config.Lan].targetinfo["open_bossmenu"], job = bossroles, },
								}, distance = 2.0 })
        ...
        elseif loc.MLO == "JX" then]]
            if loc.MLO == "JX" then
			--Stash/Shops

            Targets["BShelf"] =
            exports['qb-target']:AddBoxZone("BShelf", vector3(-1198.54, -893.29, 13.45), 1.5, 1.3, { name="BShelf", heading = 34.0, debugPoly=Config.Debug, minZ = 13.78, maxZ = 14.78, },
                { options = { { event = "jim-burgershot:Stash", icon = "fas fa-box-open", label = Loc[Config.Lan].targetinfo["open_shelves"], job = Config.Locations[1].job, id = "BSShelf", coords = vector3(-1198.54, -893.29, 13.45) }, },
                    distance = 2.0 })
            Targets["BShelf2"] =
            exports['qb-target']:AddBoxZone("BShelf2", vector3(-1197.63, -894.49, 13.42), 1.5, 1.3, { name="BShelf2", heading = 34.0, debugPoly=Config.Debug, minZ = 13.78, maxZ = 14.78, },
                { options = { { event = "jim-burgershot:Stash", icon = "fas fa-box-open", label = Loc[Config.Lan].targetinfo["open_shelves"], job = Config.Locations[1].job, id = "BSShelf2", coords = vector3(-1197.63, -894.49, 13.42) }, },
                    distance = 2.0 })
            Targets["BShelf3"] =
            exports['qb-target']:AddBoxZone("BShelf3", vector3(-1196.72, -895.68, 13.42), 1.5, 1.3, { name="BShelf3", heading = 34.0, debugPoly=Config.Debug, minZ = 13.78, maxZ = 14.78, },
                { options = { { event = "jim-burgershot:Stash", icon = "fas fa-box-open", label = Loc[Config.Lan].targetinfo["open_shelves"], job = Config.Locations[1].job, id = "BSShelf3", coords = vector3(-1196.72, -895.68, 13.42) }, },
                    distance = 2.0 })
            Targets["BFridge"] =
			exports['qb-target']:AddBoxZone("BFridge", vector3(-1203.89, -896.0, 13.84), 1.5, 1.3, { name="BFridge", heading = 304.0, debugPoly=Config.Debug, minZ = 13, maxZ = 14, },
				{ options = { { event = "jim-burgershot:Stash", icon = "fas fa-temperature-low", label = Loc[Config.Lan].targetinfo["open_fridge"], job = Config.Locations[1].job, id = "BSFridge", coords = vector3(-1203.89, -896.0, 13.84) }, },
					distance = 1.5 })

            --[[
            Targets["BStore"] =
            exports['qb-target']:AddBoxZone("BStore", vector3(-1188.41, -901.0, 13.97), 1.6, 0.5, { name="BStore", heading = 34.0, debugPoly=Config.Debug, minZ = 12.97, maxZ = 15.37, },
                { options = { { event = "jim-burgershot:Shop", icon = "fas fa-temperature-low", label = Loc[Config.Lan].targetinfo["open_storage"], job = Config.Locations[1].job, id = "BSShop", shop = Config.Items, coords = vector3(-1188.41, -901.0, 13.97) }, },
                    distance = 1.5 })
            ]]
            Targets["BBag"] =
            exports['qb-target']:AddBoxZone("BBag", vector3(-1193.34, -896.38, 13.56), 1, 1, { name="BBag", heading = 34.0, debugPoly=Config.Debug, minZ = 13, maxZ = 14, },
                { options = { { event = "jim-burgershot:client:GrabBag", icon = "fas fa-bag-shopping", label = Loc[Config.Lan].targetinfo["grab_murderbag"], job = Config.Locations[1].job, },
                { event = "jim-burgershot:shop", icon = "fas fa-bag-shopping", label = Loc[Config.Lan].targetinfo["grab_toy"], job = Config.Locations[1].job, shop = Config.Toy },},
                    distance = 2.0 })
            ...
            --Food Making 
            Targets["BGrill"] =
            exports['qb-target']:AddBoxZone("BGrill", vector3(-1200.59, -900.83, 13.56), 1, 1.8, { name="BGrill", heading = 124.0, debugPoly=Config.Debug, minZ = 13.3, maxZ = 14, },
                { options = { { event = "jim-burgershot:Crafting", icon = "fas fa-fire", label = Loc[Config.Lan].targetinfo["use_grill"], job = Config.Locations[1].job, craftable = Crafting.Grill, header = Loc[Config.Lan].menu["grill"], coords = vector3(-1200.59, -900.83, 13.56) }, },
                    distance = 1.5 })
			Targets["BGrill1"] =
			exports['qb-target']:AddBoxZone("BGrill1", vector3(-1202.98, -897.31, 13.56), 1, 1.8, { name="BGrill1", heading = 124.0, debugPoly=Config.Debug, minZ = 13.3, maxZ = 14, },
				{ options = { { event = "jim-burgershot:Crafting", icon = "fas fa-fire", label = Loc[Config.Lan].targetinfo["use_grill"], job = Config.Locations[1].job, craftable = Crafting.Grill, header = Loc[Config.Lan].menu["grill"], coords = vector3(-1202.98, -897.31, 13.56) }, },
					distance = 1.5 })
            Targets["BFryer"] =
            exports['qb-target']:AddBoxZone("BFryer", vector3(-1201.98, -899.33, 13.56), 1, 2, { name="BFryer", heading = 124.0, debugPoly=Config.Debug, minZ = 13.3, maxZ = 14, },
                { options = { { event = "jim-burgershot:Crafting", icon = "fas fa-temperature-high", label = Loc[Config.Lan].targetinfo["use_deepfryer"], job = Config.Locations[1].job, craftable = Crafting.Fryer, header = Loc[Config.Lan].menu["deep_fat_fryer"], coords = vector3(-1201.98, -899.33, 13.56) }, },
                    distance = 1.5 })
            Targets["BChop"] =
            exports['qb-target']:AddBoxZone("BChop", vector3(-1199.41, -902.39, 13.56), 1, 2, { name="BChop", heading = 124.0, debugPoly=Config.Debug, minZ = 13.78, maxZ = 14, },
                { options = { { event = "jim-burgershot:Crafting", icon = "fas fa-utensils", label = Loc[Config.Lan].targetinfo["use_chopping_board"], job = Config.Locations[1].job, craftable = Crafting.ChopBoard, header = Loc[Config.Lan].menu["chopping_board"], coords = vector3(-1199.41, -902.39, 13.56) }, },
                    distance = 1.5 })
            Targets["BPrepare"] =
            exports['qb-target']:AddBoxZone("BPrepare", vector3(-1199.44, -897.51, 13.56), 1, 5, { name="BPrepare", heading = 124.0, debugPoly=Config.Debug, minZ = 13.78, maxZ = 14, },
                { options = { { event = "jim-burgershot:Crafting", icon = "fas fa-hamburger", label = Loc[Config.Lan].targetinfo["prepare_food"], job = Config.Locations[1].job, craftable = Crafting.Prepare, header = Loc[Config.Lan].menu["prepare_food"], coords = vector3(-1199.44, -897.51, 13.56) }, },
                    distance = 1.5 })
            Targets["BDrink"] =
            exports['qb-target']:AddBoxZone("BDrink", vector3(-1199.83, -895.61, 14.0), 1, 2, { name="BDrink", heading = 124.0, debugPoly=Config.Debug, minZ = 14, maxZ = 14.6, },
                { options = { { event = "jim-burgershot:Crafting", icon = "fas fa-mug-hot", label = Loc[Config.Lan].targetinfo["prepare_drinks"], job = Config.Locations[1].job, craftable = Crafting.Drink, header = Loc[Config.Lan].menu["drinks_dispenser"], coords = vector3(-1199.83, -895.61, 14.0) }, },
                    distance = 1.5 })
            Targets["BDonut"] =
            exports['qb-target']:AddBoxZone("BDonut", vector3(-1198.46, -897.36, 13.56), 1, 2, { name="BDonut", heading = 124.0, debugPoly=Config.Debug, minZ = 13.4, maxZ = 14.5, },
                { options = { { event = "jim-burgershot:Crafting", icon = "fas fa-dot-circle", label = Loc[Config.Lan].targetinfo["open_cabinet"], job = Config.Locations[1].job, craftable = Crafting.Donut, header = Loc[Config.Lan].targetinfo["food_cabinet"], coords = vector3(-1198.46, -897.36, 13.56) }, },
                    distance = 1.5 })

            --Hand Washing
            -- Targets["BWash1"] =
            -- exports['qb-target']:AddBoxZone("BWash1", vector3(-1197.5, -902.87, 13.01), 0.6, 0.6, { name="BWash1", heading = 216.5, debugPoly=Config.Debug, minZ = 13, maxZ = 14, },
            --     { options = { { event = "jim-burgershot:washHands", icon = "fas fa-hand-holding-water", label = Loc[Config.Lan].targetinfo["wash_hands"], }, },
            --         distance = 2.0 })

            --Trays
            Targets["BTray1"] =
            exports['qb-target']:AddBoxZone("BTray1", vector3(-1195.94, -891.25, 13.82), 0.6, 0.6, { name="BTray1", heading = 215.0, debugPoly=Config.Debug, minZ = 14.0, maxZ = 14.5, },
                { options = { { event = "jim-burgershot:Stash", icon = "fas fa-hamburger", label = Loc[Config.Lan].targetinfo["open_tray"], id = "Tray1" }, },
                    distance = 2.0 })
            Targets["BTray2"] =
            exports['qb-target']:AddBoxZone("BTray2", vector3(-1194.69, -893.12, 13.68), 0.6, 0.6, { name="BTray2", heading = 215.0, debugPoly=Config.Debug, minZ = 14.0, maxZ = 14.5, },
                { options = { { event = "jim-burgershot:Stash", icon = "fas fa-hamburger", label = Loc[Config.Lan].targetinfo["open_tray"], id = "Tray2" }, },
                    distance = 2.0 })
            Targets["BTray3"] =
            exports['qb-target']:AddBoxZone("BTray3", vector3(-1193.28, -895.19, 13.6), 0.6, 0.6, { name="BTray3", heading = 215.0, debugPoly=Config.Debug, minZ = 14.0, maxZ = 14.5, },
                { options = { { event = "jim-burgershot:Stash", icon = "fas fa-hamburger", label = Loc[Config.Lan].targetinfo["open_tray"], id = "Tray3" }, },
                    distance = 2.0 })

            --Payments
			-- Targets["BReceipt"] =
			-- exports['qb-target']:AddBoxZone("BReceipt", vec3(-1194.89, -893.24, 14.0), 0.5, 0.5, { name="BReceipt", heading = 35.0, debugPoly=Config.Debug, minZ = 14, maxZ = 14.5, },
			-- 	{ options = { { event = "jim-payments:client:Charge", icon = "fas fa-credit-card", label = Loc[Config.Lan].targetinfo["charge_customer"], job = Config.Locations[1].job,
			-- 					img = "<center><p><img src=https://static.wikia.nocookie.net/gtawiki/images/b/bf/BurgerShot-HDLogo.svg width=225px></p>" }, },
			-- 		distance = 1.5 })

			-- Targets["BReceipt2"] =
			-- exports['qb-target']:AddBoxZone("BReceipt2", vec3(-1193.88, -894.76, 14.0), 0.5, 0.5, { name="BReceipt2", heading = 35.0, debugPoly=Config.Debug, minZ = 14, maxZ = 14.5, },
			-- 	{ options = { { event = "jim-payments:client:Charge", icon = "fas fa-credit-card", label = Loc[Config.Lan].targetinfo["charge_customer"], job = Config.Locations[1].job,
			-- 					img = "<center><p><img src=https://static.wikia.nocookie.net/gtawiki/images/b/bf/BurgerShot-HDLogo.svg width=225px></p>" }, },
			-- 		distance = 1.5 })
                    
			-- Targets["BReceipt3"] =
			-- exports['qb-target']:AddBoxZone("BReceipt3", vec3(-1192.9, -896.21, 14.0), 0.5, 0.5, { name="BReceipt3", heading = 35.0, debugPoly=Config.Debug, minZ = 14, maxZ = 14.5, },
			-- 	{ options = { { event = "jim-payments:client:Charge", icon = "fas fa-credit-card", label = Loc[Config.Lan].targetinfo["charge_customer"], job = Config.Locations[1].job,
			-- 					img = "<center><p><img src=https://static.wikia.nocookie.net/gtawiki/images/b/bf/BurgerShot-HDLogo.svg width=225px></p>" }, },
			-- 		distance = 1.5 })
            ...
            --[[
            Targets["BClockin2"] =
            exports['qb-target']:AddBoxZone("BClockin2", vector3(-1194.63, -896.98, 13.97), 1, 1, { name="BClockin2", heading = 34.0, debugPoly=Config.Debug, minZ = 13.78, maxZ = 14.58, },
                    { options = { { event = "qb-bossmenu:client:OpenMenu", icon = "fas fa-list", label = Loc[Config.Lan].targetinfo["open_bossmenu"], job = bossroles, },
                    }, distance = 2.0 })
            ]]
        end
...
RegisterNetEvent('jim-burgershot:washHands', function(data)
	if progressBar({ label = Loc[Config.Lan].progressbar["washing_hands"], time = 3000, cancel = true, dict = "mp_arresting", anim = "a_uncuff", flag = 8, icon = "fas fa-hand-holding-droplet" }) then
...
--[[STASH SHOPS]]--
RegisterNetEvent('jim-burgershot:Stash', function(data, id) --id=?
    ...
    if data.job then
        if data.job ~= 'burgershot' then return end
    end

    TriggerServerEvent('jim-burgershot:server:stash', tostring(data.id)) --tostring(data.id)
...
RegisterNetEvent('jim-burgershot:Shop', function(data)
	...
	--TriggerServerEvent("inventory:server:OpenInventory", "shop", "bugershot", data.shop)
	lookEnt(data.coords)
end)
...
local function ConsumeSuccess(itemName, type)
	...
	if QBCore.Shared.Items[itemName].hunger then
        ...
        if QBCore.Shared.Items[itemName].hunger > 0 then
            TriggerServerEvent('hud:server:RelieveStress', QBCore.Shared.Items[itemName].hunger/2)
        end
	...
	if QBCore.Shared.Items[itemName].thirst then
        ...
        if QBCore.Shared.Items[itemName].thirst > 0 then
            TriggerServerEvent('hud:server:RelieveStress', QBCore.Shared.Items[itemName].thirst/2)
        end
	end
...
RegisterNetEvent('jim-burgershot:client:Consume', function(itemName, type)
	...
	if progressBar({label = progstring..QBCore.Shared.Items[itemName].label.."..", time = math.random(3000, 8000), cancel = true, icon = itemName}) then
