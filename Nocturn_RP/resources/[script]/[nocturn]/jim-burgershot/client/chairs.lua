...
if Config.Locations[1].zoneEnable then
	if Config.Locations[1].MLO == "GN" or Config.Locations[1].MLO == "JX" then
		--==STORE FRONT==--
	...
	elseif Config.Locations[1].MLO == "Gabz" then
		--SmallTable1
		chairlist[#chairlist+1] = { coords = vector4(-1195.8, -883.69, 13.74, 305.00), stand = vector3(-1194.27, -884.38, 13.8) }
		chairlist[#chairlist+1] = { coords = vector4(-1195.35, -884.35, 13.74, 305.00), stand =  vector3(-1194.27, -884.38, 13.8) }

		chairlist[#chairlist+1] = { coords = vector4(-1194.64, -882.76, 13.74, 125.00), stand = vector3(-1194.27, -884.38, 13.8) }
		chairlist[#chairlist+1] = { coords = vector4(-1194.23, -883.35, 13.74, 125.00), stand =  vector3(-1194.27, -884.38, 13.8) }

		chairlist[#chairlist+1] = { coords = vector4(-1194.12, -882.43, 13.74, 305.00), stand = vector3(-1192.69, -883.39, 13.8) }
		chairlist[#chairlist+1] = { coords = vector4(-1193.70, -883.10, 13.74, 305.00), stand =  vector3(-1192.69, -883.39, 13.8) }
		
		chairlist[#chairlist+1] = { coords = vector4(-1192.31, -882.2, 13.74, 125.00), stand = vector3(-1192.69, -883.39, 13.8) }
		chairlist[#chairlist+1] = { coords = vector4(-1192.76, -881.54, 13.74, 125.00), stand =  vector3(-1192.69, -883.39, 13.8) }

		chairlist[#chairlist+1] = { coords = vector4(-1191.9, -881.93, 13.74, 305.00), stand = vector3(-1190.9, -882.12, 13.8) }
		chairlist[#chairlist+1] = { coords = vector4(-1192.4, -881.27, 13.74, 305.00), stand =  vector3(-1190.9, -882.12, 13.8) }

		chairlist[#chairlist+1] = { coords = vector4(-1191.04, -880.44, 13.74, 125.00), stand = vector3(-1190.9, -882.12, 13.8) }
		chairlist[#chairlist+1] = { coords = vector4(-1190.62, -881.08, 13.74, 125.00), stand =  vector3(-1190.9, -882.12, 13.8) }

		chairlist[#chairlist+1] = { coords = vector4(-1192.68, -888.15, 13.74, 305.00), stand = vector3(-1193.05, -886.47, 13.8) }
		chairlist[#chairlist+1] = { coords = vector4(-1193.2, -887.49, 13.74, 305.00), stand =  vector3(-1193.14, -886.48, 13.8) }

		chairlist[#chairlist+1] = { coords = vector4(-1191.1, -887.15, 13.74, 305.00), stand = vector3(-1191.32, -885.34, 13.8) }
		chairlist[#chairlist+1] = { coords = vector4(-1191.53, -886.41, 13.74, 305.00), stand =  vector3(-1191.32, -885.34, 13.8) }

		chairlist[#chairlist+1] = { coords = vector4(-1189.85, -885.26, 13.74, 305.00), stand = vector3(-1189.49, -884.07, 13.8) }
		chairlist[#chairlist+1] = { coords = vector4(-1189.41, -885.83, 13.74, 305.00), stand =  vector3(-1189.49, -884.07, 13.8) }
		
		chairlist[#chairlist+1] = { coords = vector4(-1188.00, -885.00, 13.74, 125.00), stand = vector3(-1189.49, -884.07, 13.8) }
		chairlist[#chairlist+1] = { coords = vector4(-1188.50, -884.25, 13.74, 125.00), stand =  vector3(-1189.49, -884.07, 13.8) }
		
		chairlist[#chairlist+1] = { coords = vector4(-1190.2, -885.44, 13.74, 125.00), stand = vector3(-1191.19, -885.34, 13.8) }
		chairlist[#chairlist+1] = { coords = vector4(-1189.83, -886.03, 13.74, 125.00), stand =  vector3(-1191.19, -885.34, 13.8) }

		chairlist[#chairlist+1] = { coords = vector4(-1191.44, -887.22, 13.74, 125.00), stand = vector3(-1192.89, -886.44, 13.8) }
		chairlist[#chairlist+1] = { coords = vector4(-1191.94, -886.57, 13.74, 125.00), stand =  vector3(-1192.89, -886.44, 13.8) }

		chairlist[#chairlist+1] = { coords = vector4(-1185.53, -888.70, 13.74, 125.00), stand = vector3(-1185.54, -889.81, 13.8) }
		chairlist[#chairlist+1] = { coords = vector4(-1186.00, -888.13, 13.74, 125.00), stand =  vector3(-1185.54, -889.81, 13.8) }

		chairlist[#chairlist+1] = { coords = vector4(-
 13.8) }

		chairlist[#chairlist+1] = { coords = vector4(-1194.12, -897.11, 13.74, 305.00), stand = vector3(-1196.47, -892.37, 13.8) }
		chairlist[#chairlist+1] = { coords = vector4(-1194.5, -896.51, 13.74, 305.00), stand =  vector3(-1196.47, -892.37, 13.8) }

		chairlist[#chairlist+1] = { coords = vector4(-1195.14, -895.54, 13.74, 305.00), stand = vector3(-1196.47, -892.37, 13.8) }
		chairlist[#chairlist+1] = { coords = vector4(-1195.63, -894.88, 13.74, 305.00), stand =  vector3(-1196.47, -892.37, 13.8) }

		chairlist[#chairlist+1] = { coords = vector4(-1196.3, -893.88, 13.74, 305.00), stand = vector3(-1196.47, -892.37, 13.8) }
		chairlist[#chairlist+1] = { coords = vector4(-1196.66, -893.32, 13.74, 305.00), stand =  vector3(-1196.47, -892.37, 13.8) }

		chairlist[#chairlist+1] = { coords = vector4(-1199.27, -889.5, 13.74, 305.00), stand = vector3(-1198.14, -889.76, 13.8) }
		chairlist[#chairlist+1] = { coords = vector4(-1199.62, -888.82, 13.74, 305.00), stand =  vector3(-1198.14, -889.76, 13.8) }

		chairlist[#chairlist+1] = { coords = vector4(-1200.45, -887.74, 13.74, 305.00), stand = vector3(-1198.14, -889.76, 13.8) }
		chairlist[#chairlist+1] = { coords = vector4(-1200.75, -887.24, 13.74, 305.00), stand =  vector3(-1198.14, -889.76, 13.8) }

		

		--Benchd
		chairlist[#chairlist+1] = { coords = vector4(-1182.69, -890.83, 13.81, 215.00), }
		chairlist[#chairlist+1] = { coords = vector4(-1183.38, -891.28, 13.81, 215.00), }
		chairlist[#chairlist+1] = { coords = vector4(-1195.34, -892.34, 13.81, 125.00), }
		chairlist[#chairlist+1] = { coords = vector4(-1194.91, -893.01, 13.81, 125.00), }
		chairlist[#chairlist+1] = { coords = vector4(-1194.35, -893.87, 13.81, 125.00), }
		chairlist[#chairlist+1] = { coords = vector4(-1193.88, -894.53, 13.81, 125.00), }
		chairlist[#chairlist+1] = { coords = vector4(-1193.27, -895.41, 13.81, 125.00), }
		chairlist[#chairlist+1] = { coords = vector4(-1192.84, -896.14, 13.81, 125.00), }
		chairlist[#chairlist+1] = { coords = vector4(-1197.92, -888.59, 13.81, 125.00), }
		chairlist[#chairlist+1] = { coords = vector4(-1198.39, -887.88, 13.81, 125.00), }
		chairlist[#chairlist+1] = { coords = vector4(-1199.0, -886.98, 13.81, 125.00), }
		chairlist[#chairlist+1] = { coords = vector4(-1199.47, -886.26, 13.81, 125.00), }
    ...
    for _, v in pairs(chairlist) do i += 1
        Chairs["BurgerChair"..i] =
            exports['qb-target']:AddBoxZone("BurgerChair"..i, vec3(v.coords.x, v.coords.y , v.coords.z-1.03), 0.6, 0.6, { name= "BurgerChair"..i, heading = v.coords[4], debugPoly = Config.Debug, minZ = v.coords.z-1.2, maxZ = v.coords.z+0.2, },
                { options = { { event = "jim-burgershot:Chair", icon = "fas fa-chair", label = Loc[Config.Lan].info["sit_down"], loc = v.coords, stand = v.stand }, },
                    distance = 2.2 })
    end
