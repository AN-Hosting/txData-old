...
vehicleCustomisationPrices = {
    cosmetics = {price = 1},
    respray = {price = 1},
    performance = {prices = {0, 1, 1, 1, 1, 1, 1}},
    turbo = {prices = {0, 1}},
    wheels = {price = 1},
...
vehicleCustomisation = {
    ...
    {category = "Toit", id = 10},
    {category = "Niveau du moteur", id = 11},
    {category = "Niveau des freins", id = 12},
    {category = "Niveau des transmissions", id = 13},
    {category = "Niveau des suspensions", id = 15},
    {category = "Niveau de Blindage", id = 16},
    {category = "Turbo", id = 18},
    {category = "Plates Sup", id = 25},
    {category = "Trim A", id = 27},
    {category = "Ornaments", id = 28},
    {category = "Tableau de bord", id = 29},
    {category = "Cadrans", id = 30},
    {category = "Haut-parleurs Portes", id = 31},
    {category = "Siège", id = 32},
    {category = "Volant", id = 33},
    {category = "Levier de vitesse", id = 34},
    {category = "Plaque", id = 35},
    {category = "Haut-parleurs", id = 36},
    {category = "Coffre", id = 37},
    {category = "Hydraulic", id = 38},
    {category = "Bloc Moteur", id = 39},
    {category = "Filtre à Air", id = 40},
    {category = "Support", id = 41},
    {category = "Barres de Toît", id = 42},
