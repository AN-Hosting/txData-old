...
function InitiateMenus(isMotorcycle, vehicleHealth, categories, welcomeLabel)
    ...
    --#[Main Menu]#--
    createMenu("mainMenu", welcomeLabel, "Choisissez une catégorie")
    ...
    for _, v in ipairs(vehicleCustomisation) do
        ...
        if amountValidMods > 0 or v.id == 18 then
            if v.id == 11 or v.id == 12 or v.id == 13 or v.id == 15 or v.id == 16 then --Performance Upgrades
                ...
                createMenu(v.category:gsub("%s+", "") .. "Menu", v.category, "Choisissez une upgrade ")
    ...
    --#[Respray Menu]#--
    createMenu("ResprayMenu", "Respray", "Choisissez une catégorie de couleurs")
    ...
    --#[Respray Types]#--
    createMenu("ResprayTypeMenu", "Respray Types", "Choisissez un type de couleur")
    ...
    --#[Respray Colours]#--
    for _, v in ipairs(vehicleResprayOptions) do
        createMenu(v.category .. "Menu", v.category .. " Colours", "Choisissez une couleur")
    ...
    createMenu("WheelsMenu", "Wheel Categories", "Choisissez une catégorie")
        ...
        elseif v.id ~= 20 then
            if isMotorcycle then
                if v.id == 6 then --Motorcycle Wheels
                    ...
                    createMenu(v.category .. "Menu", v.category .. " Wheels", "Choisissez vos roues")
    ...
    createMenu("TyreSmokeMenu", "Tyre Smoke Customisation", "Choisissez une couleur")
    ...
    createMenu("WindowTintMenu", "Window Tint Customisation", "Choisissez une teinte")
    ...
    if livCount > 0 then
        ...
        createMenu("OldLiveryMenu", "Old Livery Customisation", "Choisissez une livrée")
    ...
    createMenu("PlateIndexMenu", "Plate Colour", "Choisissez un style")
    local plateTypes = {
        "Blue on White #1",
        "Yellow on Black",
        "Yellow on Blue",
    ...
    --#[Neons Menu]#--
    createMenu("NeonsMenu", "Neon Customisation", "Choisissez une catégorie")
    ...
    createMenu("NeonColoursMenu", "Neon Colours", "Choisissez une couleur")
    ...
    --#[Xenons Menu]#--
    createMenu("XenonsMenu", "Xenon Customisation", "Choisissez une catégorie")
    ...
    createMenu("XenonColoursMenu", "Xenon Colours", "Choisissez une couleur")
