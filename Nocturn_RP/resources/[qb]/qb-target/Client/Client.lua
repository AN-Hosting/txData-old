		...
		while display do
			...
			for _, zone in pairs(Sprites) do
                ...
                DrawMarker(
                    ...
                    0.2, 0.2, 0.2, -- Taille
                    colorCodes.r, colorCodes.g, colorCodes.b, colorCodes.a, -- Couleur
                ...
                -- Dessiner l'icône d'info existante
                if zone.success and #currentEntity.options > 0 then
                    colorCodes.r = zone.targetOptions.successDrawColor?[1] or Config.SuccessDrawColor[1]
                    colorCodes.g = zone.targetOptions.successDrawColor?[2] or Config.SuccessDrawColor[2]
                    colorCodes.b = zone.targetOptions.successDrawColor?[3] or Config.SuccessDrawColor[3]
                    colorCodes.a = zone.targetOptions.successDrawColor?[4] or Config.SuccessDrawColor[4]
                elseif zone.success and #currentEntity.options == 0 then
                    colorCodes.r = zone.targetOptions.errorDrawColor?[1] or Config.ErrorDrawColor[1]
                    colorCodes.g = zone.targetOptions.errorDrawColor?[2] or Config.ErrorDrawColor[2]
                    colorCodes.b = zone.targetOptions.errorDrawColor?[3] or Config.ErrorDrawColor[3]
                    colorCodes.a = zone.targetOptions.errorDrawColor?[4] or Config.ErrorDrawColor[4]
                else
                    colorCodes.r = zone.targetOptions.drawColor?[1] or Config.DrawColor[1]
                    colorCodes.g = zone.targetOptions.drawColor?[2] or Config.DrawColor[2]
                    colorCodes.b = zone.targetOptions.drawColor?[3] or Config.DrawColor[3]
                    colorCodes.a = zone.targetOptions.drawColor?[4] or Config.DrawColor[4]
                end

				SetDrawOrigin(zone.center.x, zone.center.y, zone.center.z, 0)
				DrawSprite("shared", "info_icon_32", 0, 0, 0.015, 0.025, 0, colorCodes.r, colorCodes.g, colorCodes.b, colorCodes.a)
				ClearDrawOrigin()
			end
			Wait(sleep)
		end
...
RegisterNUICallback('SET_MENU_STATE', function(data)
    isMenuOpen = data.state
