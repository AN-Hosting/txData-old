...
Config.BreakoutMinigame = 'qb-minigames' -- Choose the cuff breakout minigame : qb-skillbar / qb-minigames (skillbar) / ps-ui (circle) / ox_lib
...
Config.Inventory = 'new-qb-inventory' -- Inventory system : qb-inventory / new-qb-inventory / ps-inventory / ox_inventory 
...
Config.Locations = {
    ...
    ["fingerprint"] = {
        [1] = vector3(475.31, -1004.61, 26.29), -- LSPD
        -- [2] = vector3(-452.22, 5997.96, 27.58), --BCSO
    },
    ["evidence"] = {
        [1] = vector3(463.57, -992.83, 26.92), -- LSPD
