...
Ticker = {
    ...
    Api_key = '6b97e67a5b91326326a1d13ceb3ec76bc68d6c90b941970c7befb4c05e2510d6', -- If you decide to get an api key for the API (https://min-api.cryptocompare.com/pricing) The free plan should be more than enough for 1 Fivem server
