...
Config.JobGarageLocations = { -- IMPORTANT - Every garage name must be unique
  ...
  ['Concessionnaire Evry'] = {
    coords = vector3(1109.48, 2633.19, 38.95),
    spawn = vector4(1110.33, 2635.63, 38.95, 88.24),
    distance = 5,
    job = {"concessionnaire"},
    type = "car",
    hideBlip = false,
  ...
  ['Norauto'] = {
    coords = vector3(563.64, -228.57, 55.83),
    spawn = vector4(582.44, -218.4, 55.83, 62.15),
    distance = 5,
    job = {"norauto"},
    type = "car",
    hideBlip = false,
  ...
  ['Police Nationale'] = {
    coords = vector3(441.78, -1013.86, 28.64),
    spawn = vector4(443.06, -1020.32, 28.6, 91.83),
    distance = 5,
