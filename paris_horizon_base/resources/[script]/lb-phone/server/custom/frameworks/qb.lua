...
local function GetSocietyMoney(job)
    local success, res = pcall(function()
        return exports['okokBanking']:GetAccount(job) --exports["qb-management"]:GetAccount(job)
    end)
...
RegisterLegacyCallback("services:addMoney", function(source, cb, amount)
    ...
    local success, _ = pcall(function()
        return exports['okokBanking']:AddMoney(job, amount)  --return exports["qb-management"]:AddMoney(job, amount)
    end)
