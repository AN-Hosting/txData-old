...
Config.SocietyCommision = 0.20  -- Percentage of the commission for the company (%30 of house price)
...
Config.Intl = {
	locales = 'fr-FR',      -- 'en-US', 'pt-BR', 'es-ES', 'fr-FR', 'de-DE', 'ru-RU', 'zh-CN'
	options = {
		style = 'currency', -- 'decimal', 'currency', 'percent', 'unit'
		currency = 'EUR',   -- 'USD', 'EUR', 'BRL', 'RUB', 'CNY'
