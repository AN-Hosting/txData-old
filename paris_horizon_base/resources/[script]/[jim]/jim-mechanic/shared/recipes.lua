Crafting = {
	...
	Tools = {
		...
		Recipes = {
			...
			{ ["paintcan"] = { ["colorant"] = 1, ["metalscrap"] = 1, },
				["amount"] = 1,
			},
			...
			{ ["tint_supplies"] = { ["plastic"] = 2, },
				["amount"] = 1,
			},
			{ ["underglow_controller"] = { ["copper"] = 2, ["metalscrap"] = 2, ["pile"] = 2, ["rubber"] = 2, },
				["amount"] = 1,
			},
			...
			{ ["advancedrepairkit"] = { ["copper"] = 2, ["metalscrap"] = 2, ["rubber"] = 2, },
				["amount"] = 1,
			},
			{ ["repairkit"] = { ["copper"] = 1, ["metalscrap"] = 1, ["rubber"] = 1, },
				["amount"] = 1,
			},
	...
	Perform = {
		...
		Anims = { animDict = "mini@repair", anim = "fixing_a_ped",},
		Recipes = {
			{ ["turbo"] = { ["ressort"] = 2, ["metalscrap"] = 5, },
				["amount"] = 1,
			},
			{ ["car_armor"] = { ["metalscrap"] = 5, ["carbon"] = 2, },
				["amount"] = 1,
			},
			{ ["engine1"] = { ["newoil"] = 1, ["metalscrap"] = 2, ["rubber"] = 2, },
				["amount"] = 1,
			},
			{ ["engine2"] = { ["newoil"] = 1, ["metalscrap"] = 4, ["rubber"] = 3, },
				["amount"] = 1,
			},
			{ ["engine3"] = { ["newoil"] = 1, ["metalscrap"] = 7, ["rubber"] = 5, },
				["amount"] = 1,
			},
			{ ["engine4"] = { ["newoil"] = 1, ["metalscrap"] = 9, ["rubber"] = 6, },
				["amount"] = 1,
			},
			{ ["engine5"] = { ["newoil"] = 1, ["metalscrap"] = 10, ["rubber"] = 7, },
				["amount"] = 1,
			},
			{ ["transmission1"] = { ["metalscrap"] = 3, ["rubber"] = 1, ["ressort"] = 1, },
				["amount"] = 1,
			},
			{ ["transmission2"] = { ["metalscrap"] = 4, ["rubber"] = 1, ["ressort"] = 2, },
				["amount"] = 1,
			},
			{ ["transmission3"] = { ["metalscrap"] = 5, ["rubber"] = 1, ["ressort"] = 3, },
				["amount"] = 1,
			},
			{ ["transmission4"] = { ["metalscrap"] = 6, ["rubber"] = 1, ["ressort"] = 4, },
				["amount"] = 1,
			},
			{ ["brakes1"] = {  ["metalscrap"] = 1, ["platinum"] = 2, },
				["amount"] = 1,
			},
			{ ["brakes2"] = { ["metalscrap"] = 2, ["platinum"] = 3, },
				["amount"] = 1,
			},
			{ ["brakes3"] = { ["metalscrap"] = 3, ["platinum"] = 4, },
				["amount"] = 1,
			},
			{ ["suspension1"] = { ["metalscrap"] = 2, ["ressort"] = 4, },
				["amount"] = 1,
			},
			{ ["suspension2"] = { ["metalscrap"] = 2, ["ressort"] = 4, ["platinum"] = 1, },
				["amount"] = 1,
			},
			{ ["suspension3"] = { ["metalscrap"] = 2, ["ressort"] = 4, ["platinum"] = 2, },
				["amount"] = 1,
			},
			{ ["suspension4"] = { ["metalscrap"] = 2, ["ressort"] = 4, ["platinum"] = 3, },
				["amount"] = 1,
			},
			{ ["suspension5"] = { ["metalscrap"] = 2, ["ressort"] = 4, ["platinum"] = 4, },
				["amount"] = 1,
			},
			

			-- { ["oilp1"] = { ["metalscrap"] = 2, ["newoil"] = 1, ["copper"] = 1, },
			-- 	["amount"] = 1,
			-- },
			-- { ["oilp2"] = { ["metalscrap"] = 2, ["newoil"] = 1, ["copper"] = 2, },
			-- 	["amount"] = 1,
			-- },
			-- { ["oilp3"] = { ["metalscrap"] = 2, ["newoil"] = 1, ["copper"] = 3, },
			-- 	["amount"] = 1,
			-- },
			-- { ["drives1"] = { ["metalscrap"] = 4, },
			-- 	["amount"] = 1,
			-- },
			-- { ["drives2"] = { ["metalscrap"] = 6, },
			-- 	["amount"] = 1,
			-- },
			-- { ["drives3"] = { ["metalscrap"] = 8, },
			-- 	["amount"] = 1,
			-- },
			-- { ["cylind1"] = { ["metalscrap"] = 3, ["newoil"] = 1, ["rubber"] = 2, },
			-- 	["amount"] = 1,
			-- },
			-- { ["cylind2"] = { ["metalscrap"] = 6, ["newoil"] = 1, ["rubber"] = 4, },
			-- 	["amount"] = 1,
			-- },
			-- { ["cylind3"] = { ["metalscrap"] = 9, ["newoil"] = 1, ["rubber"] = 6, },
			-- 	["amount"] = 1,
			-- },
			-- { ["cables1"] = { ["copper"] = 2, ["rubber"] = 1, },
			-- 	["amount"] = 1,
			-- },
			-- { ["cables2"] = { ["copper"] = 4, ["rubber"] = 1, },
			-- 	["amount"] = 1,
			-- },
			-- { ["cables3"] = { ["copper"] = 6, ["rubber"] = 1, },
			-- 	["amount"] = 1,
			-- },

			-- { ["fueltank1"] = { ["metalscrap"] = 2, },
			-- 	["amount"] = 1,
			-- },
			-- { ["fueltank2"] = { ["metalscrap"] = 4, },
			-- 	["amount"] = 1,
			-- },
			-- { ["fueltank3"] = { ["metalscrap"] = 6, },
			-- 	["amount"] = 1,
			-- },

			{ ["antilag"] = { ["metalscrap"] = 2, ["copper"] = 2, ["rubber"] = 2, },
				["amount"] = 1,
			},
	...
	Cosmetic = {
		...
		Recipes = {
			...
			{ ["exhaust"] = { ["metalscrap"] = 4, },
				["amount"] = 1,
			},
			{ ["seat"] = { ["cuir"] = 4, },
				["amount"] = 1,
			},
			{ ["livery"] = { ["plastic"] = 2, ["colorant"] = 2, },
				["amount"] = 1,
			},
			{ ["tires"] = { ["rubber"] = 1, ["colorant"] = 2, },
				["amount"] = 1,
			},
			{ ["horn"] = { ["plastic"] = 3, ["copper"] = 2, },
				["amount"] = 1,
			},
			{ ["internals"] = { ["plastic"] = 2, ["cuir"] = 2, },
				["amount"] = 1,
			},
			{ ["externals"] = { ["plastic"] = 2, ["carbon"] = 2, },
				["amount"] = 1,
			},
			{ ["customplate"] = { ["metalscrap"] = 2, ["colorant"] = 2, },
				["amount"] = 1,
			},
			{ ["headlights"] = { ["ampoule"] = 4, ["plastic"] = 2, },
				["amount"] = 1,
			},
			{ ["rims"] = { ["metalscrap"] = 3, ["carbon"] = 3, },
				["amount"] = 1,
			},
			{ ["underglow"] = { ["ampoule"] = 4, ["plastic"] = 2, },
				["amount"] = 1,
			},
			{ ["rollcage"] = { ["metalscrap"] = 3, },
				["amount"] = 1,
			},
		},
	},
