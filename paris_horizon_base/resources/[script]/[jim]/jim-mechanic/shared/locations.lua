...
Config.Locations[#Config.Locations+1] = { --[[ GABZ ALTA STREET BENNYS ]]--
	...
	stash = {
		{ coords = vec4(839.4, -905.51, 0.0, 180.99), w = 6.6, d = 0.8, },
	},
	store = {
	...
	Restrictions = {
		...
		Allow = { "tools", "cosmetics", "perform" },
	},
	blip = {
		coords = vec3(807.66, -882.89, 25.25),
		label = "Norauto",
		color = 0,
		sprite = 72,
		disp = 4,
...
Config.Locations[#Config.Locations+1] = { --[[ LS CUSTOMS IN CITY ]]--
	...
	autoClock = { enter = false, exit = false, },
	stash = {
		{ coords = vec4(-802.6, -447.12, 00.64, 171.09), w = 4.0, d = 1.0, },
	},
	store = {
		{ coords = vec4(-802.6, -447.12, 00.64, 171.09), w = 1.2, d = 0.25, },
	},
	crafting = {
		{ coords = vec4(-809.88, -431.48, 36.00, 115.79), w = 4.2, d = 2.0, },
		{ coords = vec4(-803.12, -431.65, 36.00, 25.23), w = 3.9, d = 1.0, },
		{ coords = vec4(-806.13, -425.69, 36.00, 25.42), w = 3.9, d = 1.0, },
		{ coords = vec4(-815.42, -416.78, 36.00, 115.46), w = 3.9, d = 1.0, },
	},
	clockin = {
		{ coords = vec4(-802.6, -447.12, 00.64, 171.09), prop = true },
	},
	manualRepair = {
		{ coords = vec4(-802.6, -447.12, 00.64, 171.09), prop = true, },
	},
	garage = {
		spawn = vec4(-802.6, -447.12, 00.64, 171.09),
		out = vec4(-802.6, -447.12, 00.64, 171.09),
		list = { "towtruck", "panto", "slamtruck", "cheburek", "utillitruck3" },
		prop = true
	},
	payments = {
	...
	blip = {
		coords = vec3(-820.51, -430.49, 36.83),
		label = "Garage Phantom",
		color = 0,
		sprite = 446,
		disp = 4,
		scale = 0.7,
