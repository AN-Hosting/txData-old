function RobberiesCreator.playHackablePanel(stepStaticId, heistId, objectData)
    ...
    if(isSuccessful) then
        TriggerServerEvent(Utils.eventsPrefix .. ":heist:hackPanelSuccess", stepStaticId)
    else
        TriggerServerEvent(Utils.eventsPrefix .. ":heist:hackPanelFail", stepStaticId)
    end
end