...
local function voldesac()
    local coords = GetEntityCoords(cache.ped)

    local dispatchData = {
        message = locale('voldesac'),
        codeName = 'voldesac',
        code = '10-65',
        icon = 'fas fa-house',
        priority = 2,
...
local function VolDeSacs()
    local coords = GetEntityCoords(cache.ped)
    local vehicle = GetVehicleData(cache.vehicle)

    local dispatchData = {
        message = locale('VolDeSacs'), -- add this into your locale
        codeName = 'VolDeSacs', -- this should be the same as in config.lua
        code = '10-35',
        icon = 'fas fa-car-burst',
        priority = 2,
        coords = coords,
