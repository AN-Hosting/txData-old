local Translations = {
    error = {
        ...
        no_empty_weed_bag = "Il vous manque des pochons vides",
        no_coke_brick = "Il vous manque une brick de cocaïne !",
    },
    success = {
        ...
        baggy = "Vous avez mis la weed en pochon",
    },
    info = {
    ...
    target = {
        ...
        coke_cutting = "Découper la brick",
    },
    drawtext = {
