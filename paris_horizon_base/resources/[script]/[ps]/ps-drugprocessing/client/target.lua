...
CreateThread(function()
    ...
    exports["qb-target"]:AddBoxZone("methbagging", vector3(987.81, -140.43, -49.0), 1.5, 1.5, {
        name = "methbagging",
        heading = 0,
        debugPoly = false,
        minZ = -50.0,
        ...
        options = {
            {
                type = "client",
                event = "ps-drugprocessing:client:bagMeth",
                icon = "fas fa-bag-shopping",
                label = "Mettre en sachet",
            },
        },
    distance = 3.5
    })
    ...
    exports['qb-target']:AddBoxZone("weedbagging", vector3(1034.15, -3205.57, -38.39), 1.5, 1.5, {
        name = "weedbagging",
        heading = 0,
        debugPoly = false,
        minZ = -39.39,
        ...
        options = {
            {
                type = "client",
                event = "ps-drugprocessing:client:bagskunk",
                icon = "fas fa-bag-shopping",
                label = Lang:t("target.bagging"),
            },
        },
    ...
    exports['qb-target']:AddBoxZone("cokecutting", vector3(1101.61, -3199.43, -39.28), 1.5, 1.5, {
        name = "cokecutting",
        heading = 0,
        debugPoly = false,
        minZ = -40.28,
        ...
        options = {
            {
                type = "client",
                event = "ps-drugprocessing:client:cutCokeBrick",
                icon = "fas fa-scissors",
                label = Lang:t("target.coke_cutting"),
            },
        },
        distance = 3.5
    })
