...
Config.CircleZones = {
	...
	WeedBagging = {coords = vector3(1034.15, -3205.57, -38.39), name = ('Weed Bagging'), radius = 20.0},
	...
	CokeBrick = {coords = vector3(1099.57, -3194.35, -38.99), name = ('Brick Up Packages'), radius = 20.0},
	CokeCutting = {coords = vector3(1101.61, -3199.43, -39.28), name = ('Brick Cutting'), radius = 20.0},
...
Config.DrugDealerLocations = {
    {coords = vector4(-1415.53, -446.75, 35.91, 67.24), label = "Vendeur - Plage"},
    {coords = vector4(1992.07, 3044.12, 47.21, 146.87), label = "Vendeur - Sandy"},
    {coords = vector4(-41.65, -1446.63, 31.89, 278.54), label = "Vendeur - Sud"},
}
