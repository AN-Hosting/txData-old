...
QBShared.Jobs = {
	...
	gendarmerie_nationale = {
		...
		offDutyPay = false,
		grades = {
			['0'] = { name = 'GAV', payment = 1000 },
			['1'] = { name = 'Élève Gendarme', payment = 1150 },
			['2'] = { name = 'Gendarme', payment = 1300 },
			['3'] = { name = 'Maréchal des logis', payment = 1500 },
			['4'] = { name = 'Maréchal des logis-chef', payment = 1700 },
			['5'] = { name = 'Adjudant', payment = 1900 },
			['6'] = { name = 'Adjudant-chef', isboss = true, payment = 2100 },
			['7'] = { name = 'Major', isboss = true, payment = 2500 },
			['8'] = { name = 'Aspirant', payment = 2700 },
			['9'] = { name = 'Lieutenant', payment = 2900 },
			['10'] = { name = 'Capitaine', payment = 3100 },
			['11'] = { name = 'Commandant', payment = 3300 },
			['12'] = { name = 'Lieutenant-colonel', isboss = true, payment = 3500 },
			['13'] = { name = 'Colonel', isboss = true, payment = 4000 },
		},
	},
	samu_75 = {
		label = 'Samu 75',
