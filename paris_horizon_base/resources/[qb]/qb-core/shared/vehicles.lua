...
local Vehicles = {
    ...
    -- Aston
    { model = 'amdbx',          name = 'Aston Martin DBX Carbon Edition',           brand = 'Aston',    price = 387000,          category = 'aston',         type = 'automobile', shop = 'pdm' },
    { model = 'ast',            name = '2013 Aston Martin Vanquish',                brand = 'Aston',    price = 365000,          category = 'aston',         type = 'automobile', shop = 'pdm' },
    { model = 'tltypes',        name = 'Acura TL Type-S',                           brand = 'Aston',    price = 98000,           category = 'aston',         type = 'automobile', shop = 'pdm' },

    -- Audi
    { model = 'aaq4',           name = '2017 A4 Quattro ABT',                       brand = 'Audi',     price = 87000,           category = 'audi',          type = 'automobile', shop = 'pdm' },
    { model = 'q820',           name = '2020 Q8 50TDI',                             brand = 'Audi',     price = 120000,          category = 'audi',          type = 'automobile', shop = 'pdm' },
    { model = 'r820',           name = '2020 R8',                                   brand = 'Audi',     price = 395000,          category = 'audi',          type = 'automobile', shop = 'pdm' },
    { model = 'r8ppi',          name = '2013 R8 V10',                               brand = 'Audi',     price = 385000,          category = 'audi',          type = 'automobile', shop = 'pdm' },
    { model = 'rs6',            name = '2016 RS6 C7',                               brand = 'Audi',     price = 175000,          category = 'audi',          type = 'automobile', shop = 'pdm' },
    { model = 'rs72020',        name = '2020 RS7',                                  brand = 'Audi',     price = 195000,          category = 'audi',          type = 'automobile', shop = 'pdm' },
    { model = 'sq72016',        name = '2016 SQ7',                                  brand = 'Audi',     price = 140000,          category = 'audi',          type = 'automobile', shop = 'pdm' },
    { model = 'ttrs',           name = '2010 TT RS',                                brand = 'Audi',     price = 95000,           category = 'audi',          type = 'automobile', shop = 'pdm' }, 
    { model = 'ocnetrongt',     name = 'E-TRON GT',                                 brand = 'Audi',     price = 170000,          category = 'audi',          type = 'automobile', shop = 'pdm' },
    { model = 'rs615',          name = 'RS6',                                       brand = 'Audi',     price = 180000,          category = 'audi',          type = 'automobile', shop = 'pdm' },



    -- Bentley
    { model = 'bbentayga',      name = 'Bentayga',                                  brand = 'Bentley',  price = 420000,          category = 'bentley',       type = 'automobile', shop = 'pdm' },
    { model = 'cgts',           name = '2020 Continental GT Convertible',           brand = 'Bentley',  price = 460000,          category = 'bentley',       type = 'automobile', shop = 'pdm' },
    ...
    { model = 'm3e92',          name = '2008 M3 e92',                               brand = 'BMW',      price = 130000,          category = 'bmw',           type = 'automobile', shop = 'pdm' },
    { model = 'm3f80',          name = '2015 M3 (F80)',                             brand = 'BMW',      price = 145000,          category = 'bmw',           type = 'automobile', shop = 'pdm' },
    { model = 'm4f82',          name = '2015 M4 F82',                               brand = 'BMW',      price = 150000,          category = 'bmw',           type = 'automobile', shop = 'pdm' },
    { model = 'm6f13',          name = 'M6 F13 Shadow Line',                        brand = 'BMW',      price = 170000,          category = 'bmw',           type = 'automobile', shop = 'pdm' },
    { model = 'x5e53',          name = 'X5 E53 2005 Sport Package',                 brand = 'BMW',      price = 90000,           category = 'bmw',           type = 'automobile', shop = 'pdm' },
    { model = 'x6m',            name = 'X6M F16',                                   brand = 'BMW',      price = 185000,          category = 'bmw',           type = 'automobile', shop = 'pdm' },
    { model = 'z419',           name = '2019 Z4 M40i',                              brand = 'BMW',      price = 125000,          category = 'bmw',           type = 'automobile', shop = 'pdm' },
    { model = 'e34',            name = '1995 BMW M5 E34',                           brand = 'BMW',      price = 110000,          category = 'bmw',           type = 'automobile', shop = 'pdm' },  
    { model = 'ocni422spe',     name = 'i4',                                        brand = 'BMW',      price = 155000,          category = 'bmw',           type = 'automobile', shop = 'pdm' },
    { model = 'm6prior',        name = 'M6 PRIOR',                                  brand = 'BMW',      price = 250000,          category = 'bmw',           type = 'automobile', shop = 'pdm' },


    -- Bugatti
    { model = 'bolide',         name = '2020 Bolide',                               brand = 'Bugatti',  price = 1950000,         category = 'bugatti',       type = 'automobile', shop = 'pdm' },

    -- Cadillac
    { model = 'cats',           name = '2016 ATS-V Coupe',                          brand = 'Cadillac', price = 95000,           category = 'cadillac',      type = 'automobile', shop = 'pdm' },
    { model = 'cesc21',         name = '2021 Escalade',                             brand = 'Cadillac', price = 175000,          category = 'cadillac',      type = 'automobile', shop = 'pdm' },   
    { model = 'kev',            name = 'CTSV 2012',                                 brand = 'Cadillac', price = 120000,          category = 'cadillac',      type = 'automobile', shop = 'pdm' },


    -- Citroen
    { model = 'cit2cv',        name = '2 chevaux',                                brand = 'Citroen',price = 25000,              category = 'citroen',       type = 'automobile', shop = 'pdm' },

    -- Chevrolet
    { model = '09tahoe',        name = '2009 Tahoe',                                brand = 'Chevrolet',price = 75000,          category = 'chevrolet',     type = 'automobile', shop = 'pdm' },
    { model = '15tahoe',        name = '2015 Tahoe',                                brand = 'Chevrolet',price = 95000,          category = 'chevrolet',     type = 'automobile', shop = 'pdm' },
    { model = '2020ss',         name = '2020 Camaro SS',                            brand = 'Chevrolet',price = 130000,          category = 'chevrolet',     type = 'automobile', shop = 'pdm' },
    { model = 'c7',             name = '2014 Corvette C7 Stingray',                 brand = 'Chevrolet',price = 165000,          category = 'chevrolet',     type = 'automobile', shop = 'pdm' },
    { model = 'camrs17',        name = '2017 Camaro RS',                            brand = 'Chevrolet',price = 120000,          category = 'chevrolet',     type = 'automobile', shop = 'pdm' },
    { model = 'corvettec5z06',  name = 'Corvette C5 Z06',                           brand = 'Chevrolet',price = 140000,          category = 'chevrolet',     type = 'automobile', shop = 'pdm' },
    { model = 'czr1',           name = '2009 Corvette ZR1',                         brand = 'Chevrolet',price = 180000,          category = 'chevrolet',     type = 'automobile', shop = 'pdm' },
    { model = 'stingray',       name = '2020 Corvette C8 Stingray',                 brand = 'Chevrolet',price = 210000,          category = 'chevrolet',     type = 'automobile', shop = 'pdm' },
    { model = 'tahoe21',        name = '2021 Tahoe RST',                            brand = 'Chevrolet',price = 120000,          category = 'chevrolet',     type = 'automobile', shop = 'pdm' },

    -- Dacia
    { model = '1310',           name = '1310 2001',                                 brand = 'Dacia',    price = 20000,          category = 'dacia',         type = 'automobile', shop = 'pdm' },
    { model = 'cutlass',        name = 'logan pickup ',                             brand = 'Dacia',    price = 30000,          category = 'dacia',         type = 'automobile', shop = 'pdm' },
    { model = 'logan',          name = '2008 Logan',                                brand = 'Dacia',    price = 25000,          category = 'dacia',         type = 'automobile', shop = 'pdm' },
    { model = 'sandero',        name = 'Sandero 2014',                              brand = 'Dacia',    price = 28000,          category = 'dacia',         type = 'automobile', shop = 'pdm' },
    { model = 'stepway',        name = 'Sandero Stepway 2014',                      brand = 'Dacia',    price = 32000,          category = 'dacia',         type = 'automobile', shop = 'pdm' },

    -- Dodge
    { model = '16challenger',   name = '2016 Challenger',                           brand = 'Dodge',    price = 95000,          category = 'dodge',         type = 'automobile', shop = 'pdm' },
    { model = '16charger',      name = '2016 Charger',                              brand = 'Dodge',    price = 100000,          category = 'dodge',         type = 'automobile', shop = 'pdm' },
    { model = '99viper',        name = '1999 Viper GTS ACR',                        brand = 'Dodge',    price = 180000,           category = 'dodge',         type = 'automobile', shop = 'pdm' },
    { model = 'chr20',          name = '2021 Charger Hellcat Widebody',             brand = 'Dodge',    price = 155000,          category = 'dodge',         type = 'automobile', shop = 'pdm' },
    { model = 'demon',          name = '2018 Challenger SRT Demon',                 brand = 'Dodge',    price = 195000,          category = 'dodge',         type = 'automobile', shop = 'pdm' },
    { model = 'raid',           name = 'Challenger Raid',                           brand = 'Dodge',    price = 165000,          category = 'dodge',         type = 'automobile', shop = 'pdm' },
    { model = 'ram2500',        name = '2015 RAM 2500',                             brand = 'Dodge',    price = 130000,          category = 'dodge',         type = 'automobile', shop = 'pdm' },
    { model = 'srt4',           name = 'Neon SRT-4',                                brand = 'Dodge',    price = 50000,          category = 'dodge',         type = 'automobile', shop = 'pdm' },
    { model = 'trx',            name = '2017 RAM 1500 Rebel TRX',                   brand = 'Dodge',    price = 140000,          category = 'dodge',         type = 'automobile', shop = 'pdm' },

    -- Ferrari
    { model = '488',            name = '488 Spider',                                brand = 'Ferrari',  price = 450000,          category = 'ferrari',       type = 'automobile', shop = 'pdm' },
    { model = 'f430s',          name = 'F430 Scuderia',                             brand = 'Ferrari',  price = 430000,          category = 'ferrari',       type = 'automobile', shop = 'pdm' },
    { model = 'f812',           name = '812 Superfast',                             brand = 'Ferrari',  price = 490000,           category = 'ferrari',       type = 'automobile', shop = 'pdm' },
    { model = 'fct',            name = 'California T',                              brand = 'Ferrari',  price = 420000,          category = 'ferrari',       type = 'automobile', shop = 'pdm' },
    { model = 'fxxk',           name = 'FXX-K Hybrid Hypercar',                     brand = 'Ferrari',  price = 870000,           category = 'ferrari',       type = 'automobile', shop = 'pdm' },
    { model = 'laferrari',      name = 'LaFerrari',                                 brand = 'Ferrari',  price = 850000,          category = 'ferrari',       type = 'automobile', shop = 'pdm' },
    { model = 'mig',            name = 'Enzo',                                      brand = 'Ferrari',  price = 780000,           category = 'ferrari',       type = 'automobile', shop = 'pdm' },
    { model = 'yFe458i1',       name = '458 Italia',                                brand = 'Ferrari',  price = 410000,           category = 'ferrari',       type = 'automobile', shop = 'pdm' },
    { model = 'yFe458i2',       name = '458 Speciale',                              brand = 'Ferrari',  price = 440000,           category = 'ferrari',       type = 'automobile', shop = 'pdm' },
    { model = 'yFe458s1',       name = '458 Spider',                                brand = 'Ferrari',  price = 425000,          category = 'ferrari',       type = 'automobile', shop = 'pdm' },
    { model = 'yFe458s2',       name = '458 Speciale Aperta',                       brand = 'Ferrari',  price = 455000,           category = 'ferrari',       type = 'automobile', shop = 'pdm' },
    { model = 'yFeF12A',        name = 'F60 America',                               brand = 'Ferrari',  price = 650000,          category = 'ferrari',       type = 'automobile', shop = 'pdm' },
    { model = 'yFeF12T',        name = 'F12 TRS Roadster',                          brand = 'Ferrari',  price = 670000,          category = 'ferrari',       type = 'automobile', shop = 'pdm' },

    -- Ford
    { model = 'f150',           name = '2012 F150 SVT Raptor R',                    brand = 'Ford',     price = 125000,         category = 'ford',          type = 'automobile', shop = 'pdm' },
    { model = 'fgt',            name = '2005 GT',                                   brand = 'Ford',     price = 350000,          category = 'ford',          type = 'automobile', shop = 'pdm' },
    { model = 'gt17',           name = '2017 GT',                                   brand = 'Ford',     price = 450000,           category = 'ford',          type = 'automobile', shop = 'pdm' },
    { model = 'raptor2017',     name = '2017 Raptor',                               brand = 'Ford',     price = 165000,          category = 'ford',          type = 'automobile', shop = 'pdm' },
    { model = 'wildtrak',       name = '2021 Bronco Wildtrak',                      brand = 'Ford',     price = 115000,          category = 'ford',          type = 'automobile', shop = 'pdm' },

    -- Honda
    { model = 'ap2',            name = 'S2000 AP2',                                 brand = 'Honda',    price = 95000,          category = 'honda',         type = 'automobile', shop = 'pdm' },
    { model = 'fk8',            name = '2018 Civic Type-R (FK8)',                   brand = 'Honda',    price = 85000,          category = 'honda',         type = 'automobile', shop = 'pdm' },
    { model = 'honcrx91',       name = 'CRX SiR 1991',                              brand = 'Honda',    price = 65000,          category = 'honda',         type = 'automobile', shop = 'pdm' },
    { model = 'na1',            name = '1992 NSX-R (NA1)',                          brand = 'Honda',    price = 225000,          category = 'honda',         type = 'automobile', shop = 'pdm' },

    -- ItalDesign
    { model = 'it18',           name = '2017 Zerouno',                              brand = 'ItalDesign',price = 750000,         category = 'italdesign',    type = 'automobile', shop = 'pdm' },

    -- Jaguar
    { model = 'fpacehm',        name = 'F-pace 2017 Hamann Edition',                brand = 'Jaguar',   price = 145000,          category = 'jaguar',        type = 'automobile', shop = 'pdm' },

    -- Jeep
    { model = 'jeep2012',       name = '2012 Wrangler',                             brand = 'Jeep',     price = 85000,          category = 'jeep',          type = 'automobile', shop = 'pdm' },
    { model = 'jeepreneg',      name = 'Renegade',                                  brand = 'Jeep',     price = 70000,          category = 'jeep',          type = 'automobile', shop = 'pdm' },
    { model = 'srt8',           name = '2015 SRT-8',                                brand = 'Jeep',     price = 110000,          category = 'jeep',          type = 'automobile', shop = 'pdm' },
    { model = 'trhawk',         name = '2018 Grand Cherokee',                       brand = 'Jeep',     price = 120000,          category = 'jeep',          type = 'automobile', shop = 'pdm' },

    -- Koenigsegg
    { model = 'agerars',        name = '2017 Agera RS',                             brand = 'Koenigsegg',price = 875000,         category = 'koenigsegg',    type = 'automobile', shop = 'pdm' },
    { model = 'regera',         name = 'Regera',                                    brand = 'Koenigsegg',price = 895000,         category = 'koenigsegg',    type = 'automobile', shop = 'pdm' },

    -- Lamborghini
    { model = 'huracanst',      name = 'Huracan Super Trofeo',                      brand = 'Lamborghini',price = 550000,        category = 'lamborghini',   type = 'automobile', shop = 'pdm' },
    { model = 'lambose',        name = 'Sesto Elemento',                            brand = 'Lamborghini',price = 720000,        category = 'lamborghini',   type = 'automobile', shop = 'pdm' },
    { model = 'lp670sv',        name = '2009 Murcielago LP 670-4 SV',               brand = 'Lamborghini',price = 580000,        category = 'lamborghini',   type = 'automobile', shop = 'pdm' },
    { model = 'lp700r',         name = '2013 Aventador LP700-4 Roadster',           brand = 'Lamborghini',price = 630000,        category = 'lamborghini',   type = 'automobile', shop = 'pdm' },
    { model = 'svj63',          name = 'Aventador SVJ',                             brand = 'Lamborghini',price = 780000,        category = 'lamborghini',   type = 'automobile', shop = 'pdm' },
    { model = 'urus',           name = 'Urus',                                      brand = 'Lamborghini',price = 425000,        category = 'lamborghini',   type = 'automobile', shop = 'pdm' },
    { model = 'veneno',         name = 'Veneno',                                    brand = 'Lamborghini',price = 950000,       category = 'lamborghini',   type = 'automobile', shop = 'pdm' },

    
    -- Lexus
    { model = 'gs350',          name = 'GS 350',                                    brand = 'Lexus',    price = 90000,          category = 'lexus',         type = 'automobile', shop = 'pdm' },
    { model = 'is350mod',       name = '2014 IS 350',                               brand = 'Lexus',    price = 95000,          category = 'lexus',         type = 'automobile', shop = 'pdm' },
    { model = 'rcf',            name = '2015 RCF',                                  brand = 'Lexus',    price = 120000,          category = 'lexus',         type = 'automobile', shop = 'pdm' },

    -- Lotus
    { model = 'esprit02',       name = '2002 Esprit V8',                            brand = 'Lotus',    price = 110000,          category = 'lotus',         type = 'automobile', shop = 'pdm' },
    ...
    { model = 'majfd',          name = 'RX-7 FD',                                   brand = 'Mazda',    price = 110000,          category = 'mazda',         type = 'automobile', shop = 'pdm' },
    { model = 'miata3',         name = '1989 Miata NA',                             brand = 'Mazda',    price = 60000,           category = 'mazda',         type = 'automobile', shop = 'pdm' },
    { model = 'na6',            name = 'MX-5 Miata (NA6C)',                         brand = 'Mazda',    price = 65000,           category = 'mazda',         type = 'automobile', shop = 'pdm' },

    -- McLaren
    { model = '650s',           name = '650S Coupe',                                brand = 'Mclaren',  price = 450000,          category = 'mclaren',       type = 'automobile', shop = 'pdm' },
    { model = '675lt',          name = '2016 675LT Coupe',                          brand = 'Mclaren',  price = 480000,         category = 'mclaren',       type = 'automobile', shop = 'pdm' },
    { model = '720s',           name = '2017 720S',                                 brand = 'Mclaren',  price = 510000,           category = 'mclaren',       type = 'automobile', shop = 'pdm' },
    { model = 'gtr96',          name = '1996 F1 GTR',                               brand = 'Mclaren',  price = 850000,          category = 'mclaren',       type = 'automobile', shop = 'pdm' },
    { model = 'mcst',           name = '2020 Speedtail',                            brand = 'Mclaren',  price = 750000,          category = 'mclaren',       type = 'automobile', shop = 'pdm' },
    { model = 'mp412c',         name = 'MP4-12C',                                   brand = 'Mclaren',  price = 430000,          category = 'mclaren',       type = 'automobile', shop = 'pdm' },
    { model = 'senna',          name = '2019 Senna',                                brand = 'Mclaren',  price = 890000,         category = 'mclaren',       type = 'automobile', shop = 'pdm' },

    -- Mercedes
    { model = 'c6320',          name = '2020 C63s',                                 brand = 'Mercedes', price = 175000,          category = 'mercedes',      type = 'automobile', shop = 'pdm' },
    { model = 'G65',            name = '2013 G65 AMG',                              brand = 'Mercedes', price = 220000,          category = 'mercedes',      type = 'automobile', shop = 'pdm' },
    { model = 'amggtrr20',      name = '2020 AMG GT-R Roadster',                    brand = 'Mercedes', price = 310000,          category = 'mercedes',      type = 'automobile', shop = 'pdm' },
    { model = 'e400',           name = '2019 E400 Coupe 4matic (C238)',             brand = 'Mercedes', price = 125000,          category = 'mercedes',      type = 'automobile', shop = 'pdm' },
    { model = 'gl63',           name = 'GL63 AMG',                                  brand = 'Mercedes', price = 160000,          category = 'mercedes',      type = 'automobile', shop = 'pdm' },
    { model = 'mbc63',          name = '2012 C63 AMG Coupe Black Series',           brand = 'Mercedes', price = 150000,          category = 'mercedes',      type = 'automobile', shop = 'pdm' },
    ...
    { model = 'fto',            name = 'FTO GP Version-R',                          brand = 'Nitsubishi', price = 70000,        category = 'mitsubishi',    type = 'automobile', shop = 'pdm' },

    -- Nissan
    { model = '180sx',          name = '180SX Type-X',                              brand = 'Nissan',   price = 85000,          category = 'nissan',        type = 'automobile', shop = 'pdm' },
    { model = 'Safari97',       name = '1997 Patrol Super Safari Y60',              brand = 'Nissan',   price = 75000,          category = 'nissan',        type = 'automobile', shop = 'pdm' },
    { model = 'gtr',            name = '2017 GTR',                                  brand = 'Nissan',   price = 215000,         category = 'nissan',        type = 'automobile', shop = 'pdm' },
    { model = 'gtrc',           name = '2017 R35 GTR Convertible',                  brand = 'Nissan',   price = 230000,          category = 'nissan',        type = 'automobile', shop = 'pdm' },
    { model = 'maj350',         name = 'Fairlady Z Z33',                            brand = 'Nissan',   price = 95000,          category = 'nissan',        type = 'automobile', shop = 'pdm' },
    { model = 'nis15',          name = 'Silvia S15 Spec-R',                         brand = 'Nissan',   price = 110000,          category = 'nissan',        type = 'automobile', shop = 'pdm' },
    { model = 'nissantitan17',  name = '2017 Titan Warrior',                        brand = 'Nissan',   price = 125000,          category = 'nissan',        type = 'automobile', shop = 'pdm' },
    { model = 'ns350',          name = '350z Stardast',                             brand = 'Nissan',   price = 90000,          category = 'nissan',        type = 'automobile', shop = 'pdm' },
    { model = 'nzp',            name = '370z Pandem',                               brand = 'Nissan',   price = 105000,          category = 'nissan',        type = 'automobile', shop = 'pdm' },
    { model = 's14',            name = '1998 Silvia K',                             brand = 'Nissan',   price = 100000,          category = 'nissan',        type = 'automobile', shop = 'pdm' },
    { model = 'skyline',        name = 'Skyline GT-R (BNR34)',                      brand = 'Nissan',   price = 220000,          category = 'nissan',        type = 'automobile', shop = 'pdm' },
    { model = 'z32',            name = '300ZX Z32',                                 brand = 'Nissan',   price = 85000,          category = 'nissan',        type = 'automobile', shop = 'pdm' },
    ...
    { model = 'maj935',         name = '1978 935 Moby Dick',                        brand = 'Porsche',  price = 350000,          category = 'porsche',       type = 'automobile', shop = 'pdm' },
    { model = 'pcs18',          name = '2018 Cayenne S',                            brand = 'Porsche',  price = 175000,          category = 'porsche',       type = 'automobile', shop = 'pdm' },
    { model = 'pm19',           name = '2019 Macan Turbo',                          brand = 'Porsche',  price = 160000,          category = 'porsche',       type = 'automobile', shop = 'pdm' },
    { model = 'taycan',         name = '2020 Taycan Turbo S',                       brand = 'Porsche',  price = 185000,          category = 'porsche',       type = 'automobile', shop = 'pdm' },

    -- Quartz
    { model = 'regalia',        name = 'Regalia 723',                               brand = 'Quartz',   price = 180000,          category = 'quartz',        type = 'automobile', shop = 'pdm' },

    -- Range Rover
    { model = 'rrevoque',       name = 'Range Rover Evoque',                        brand = 'Rangerover',price = 125000,         category = 'rangerover',    type = 'automobile', shop = 'pdm' },
    { model = 'rrst',           name = 'Range Rover Vogue Startech',                brand = 'Rangerover',price = 175000,         category = 'rangerover',    type = 'automobile', shop = 'pdm' },
    { model = 'rsvr16',         name = '2016 Range Rover Sport SVR',                brand = 'Rangerover',price = 190000,        category = 'rangerover',    type = 'automobile', shop = 'pdm' },
    ...
    { model = 'rrphantom',      name = '2018 Phantom VIII',                         brand = 'Rollsroyce',price = 620000,         category = 'rollsroyce',    type = 'automobile', shop = 'pdm' },
    { model = 'wraith',         name = 'Wraith',                                    brand = 'Rollsroyce',price = 480000,         category = 'rollsroyce',    type = 'automobile', shop = 'pdm' },

    -- Subaru
    { model = 'subisti08',      name = '2008 WRX STi',                              brand = 'Subaru',   price = 85000,          category = 'subaru',        type = 'automobile', shop = 'pdm' },
    { model = 'subwrx',         name = '2004 Impreza WRX STI',                      brand = 'Subaru',   price = 105000,         category = 'subaru',        type = 'automobile', shop = 'pdm' },
    { model = 'svx',            name = '1996 Alcyone SVX',                          brand = 'Subaru',   price = 75000,          category = 'subaru',        type = 'automobile', shop = 'pdm' },

    -- Suzuki
    { model = 'gsxr19',         name = '2019 GSX-R1000R',                           brand = 'Suzuki',   price = 40000,          category = 'suzuki',        type = 'automobile', shop = 'pdm' },
    { model = 'katana2',        name = '2019 Katana',                               brand = 'Suzuki',   price = 450000,          category = 'suzuki',        type = 'automobile', shop = 'pdm' },

    -- Tesla
    { model = 'models',         name = '2016 Model S P90D',                         brand = 'Tesla',    price = 140000,          category = 'tesla',         type = 'automobile', shop = 'pdm' },
    { model = 'p90d',           name = 'Model X Performance',                       brand = 'Tesla',    price = 170000,          category = 'tesla',         type = 'automobile', shop = 'pdm' },
    { model = 'teslapd',        name = '2017 Model S',                              brand = 'Tesla',    price = 135000,          category = 'tesla',         type = 'automobile', shop = 'pdm' },
    { model = 'teslax',         name = '2016 Model X P90D',                         brand = 'Tesla',    price = 160000,          category = 'tesla',         type = 'automobile', shop = 'pdm' },
    { model = 'tmodel',         name = '2018 Model 3',                              brand = 'Tesla',    price = 120000,          category = 'tesla',         type = 'automobile', shop = 'pdm' },
    { model = 'tr22',           name = '2020 Roadster',                             brand = 'Tesla',    price = 240000,          category = 'tesla',         type = 'automobile', shop = 'pdm' },

    -- Toyota
    { model = 'cam8tun',        name = '2018 Camry XSE',                            brand = 'Toyota',   price = 75000,          category = 'toyota',        type = 'automobile', shop = 'pdm' },
    { model = 'mk2100',         name = 'Mark II JZX100',                            brand = 'Toyota',   price = 95000,          category = 'toyota',        type = 'automobile', shop = 'pdm' },
    { model = 'toysupmk4',      name = '1998 Supra Turbo (A80)',                    brand = 'Toyota',   price = 185000,         category = 'toyota',        type = 'automobile', shop = 'pdm' },
    { model = 'vxr',            name = '2016 Land Cruiser VXR',                     brand = 'Toyota',   price = 165000,         category = 'toyota',        type = 'automobile', shop = 'pdm' },

    -- Volkswagen
    { model = 'amarok',         name = '2018 Amarok V6',                            brand = 'Volkswagen',price = 95000,        category = 'volkswagen',    type = 'automobile', shop = 'pdm' },
    { model = 'golfgti7',       name = '2015 Golf GTI MK7',                         brand = 'Volkswagen',price = 65000,        category = 'volkswagen',    type = 'automobile', shop = 'pdm' },
    { model = 'passat',         name = '2016 Passat B8',                            brand = 'Volkswagen',price = 95000,        category = 'volkswagen',    type = 'automobile', shop = 'pdm' },
    { model = 'vwr',            name = 'Scirocco R 2011',                           brand = 'Volkswagen',price = 85000,        category = 'volkswagen',    type = 'automobile', shop = 'pdm' },

    -- Volvo
    { model = 'xc90',           name = 'XC90 T8',                                   brand = 'Wolvo',    price = 130000,         category = 'volvo',         type = 'automobile', shop = 'pdm' },

    -- W Motors
    { model = 'lykan',          name = 'Lykan HyperSport',                          brand = 'WMotors',  price = 850000,         category = 'wmotors',       type = 'automobile', shop = 'pdm' },
    { model = 'wmfenyr',        name = 'Fenyr Supersport',                          brand = 'WMotors',  price = 895000,         category = 'wmotors',       type = 'automobile', shop = 'pdm' },

    -- Motos
    { model = 'whiplash',       name = ' Whiplash',                                 brand = 'Dinka',    price = 85000,         category = 'moto',       type = 'bike', shop = 'pdm' },
    { model = 'hellspawn',      name = ' Hellspawn',                                brand = 'LCC',      price = 110000,         category = 'moto',       type = 'bike', shop = 'pdm' },
    { model = 'lpbagger2',      name = ' Santacruz',                                brand = 'LCC',      price = 95000,         category = 'moto',       type = 'bike', shop = 'pdm' },
    { model = 'brt600',         name = ' BRT-600',                                  brand = 'Nagasaki', price = 140000,         category = 'moto',       type = 'bike', shop = 'pdm' },
    { model = 'doublec',        name = ' Double T Classic',                         brand = 'Dinka',    price = 75000,         category = 'moto',       type = 'bike', shop = 'pdm' },
    { model = 'gobi600',        name = ' Gobi 600',                                 brand = 'Nagasaki', price = 135000,         category = 'moto',       type = 'bike', shop = 'pdm' },
    { model = 'vtf1000',        name = ' VTF 1000',                                 brand = 'Suzuki',   price = 90000,         category = 'moto',       type = 'bike', shop = 'pdm' },
    { model = 'rvsuzukiltr450', name = ' LTR450 Quad',                              brand = 'Suzuki',   price = 95000,         category = 'moto',       type = 'bike', shop = 'pdm' },
    { model = 'pcx160',         name = ' New PCX160',                               brand = 'Honda',    price = 80000,         category = 'moto',       type = 'bike', shop = 'pdm' },
    { model = 'adv1502023',     name = ' 2023 ADV 150',                             brand = 'Honda',    price = 75000,         category = 'moto',       type = 'bike', shop = 'pdm' },
    { model = 'cb500f23',       name = ' 2023 CB500F',                              brand = 'Honda',    price = 85000,         category = 'moto',       type = 'bike', shop = 'pdm' },
    { model = 'bmx80rp',        name = ' 1980 Proline',                             brand = 'BMX',      price = 45000,         category = 'moto',       type = 'bike', shop = 'pdm' },
    { model = 'bmx82rmxii',     name = ' 1982 MXII',                                brand = 'BMX',      price = 48000,         category = 'moto',       type = 'bike', shop = 'pdm' },
    { model = 'bmx82rmxiii',    name = ' 1982 MXIII',                               brand = 'BMX',      price = 50000,         category = 'moto',       type = 'bike', shop = 'pdm' },
    { model = 'bmx82rpii',      name = ' 1982 Proline II',                          brand = 'BMX',      price = 42000,         category = 'moto',       type = 'bike', shop = 'pdm' },
    { model = 'bmx83600a',      name = ' 1983 600a',                                brand = 'BMX',      price = 45000,         category = 'moto',       type = 'bike', shop = 'pdm' },
    { model = 'bmx84rp',        name = ' 1984 Prostyler',                           brand = 'BMX',      price = 49000,         category = 'moto',       type = 'bike', shop = 'pdm' },
    { model = 'sahara300',      name = ' 300',                                      brand = 'Sahara',   price = 130000,         category = 'moto',       type = 'bike', shop = 'pdm' },
    { model = 'snsquash',       name = ' Squash',                                   brand = 'Honda',    price = 82000,         category = 'moto',       type = 'bike', shop = 'pdm' },
    { model = 'r12007',         name = ' R1 2007',                                  brand = 'Yamaha',   price = 95000,         category = 'moto',       type = 'bike', shop = 'pdm' },
    { model = 'HBL_DH2',        name = ' Bike',                                     brand = 'Downhill', price = 60000,         category = 'moto',       type = 'bike', shop = 'pdm' },
    { model = '110i2019',       name = ' Wave110i 2019',                            brand = 'Honda',    price = 78000,         category = 'moto',       type = 'bike', shop = 'pdm' },
    { model = 'r32025ld',       name = ' R3 2025',                                  brand = 'Yamaha',   price = 92000,         category = 'moto',       type = 'bike', shop = 'pdm' },
    { model = 'speedstercr',    name = ' Western Motorcycles',                      brand = 'Speedster',price = 145000,         category = 'moto',       type = 'bike', shop = 'pdm' },
    { model = 'pcx160_2025',    name = ' PCX160 2025',                              brand = 'Honda',    price = 84000,         category = 'moto',       type = 'bike', shop = 'pdm' },
    { model = 'r2525',          name = ' R25 2025',                                 brand = 'Yamaha',   price = 93000,         category = 'moto',       type = 'bike', shop = 'pdm' },
    { model = 'shinobi25',      name = ' Shinobi 2025 Plus',                        brand = 'Nagasaki', price = 138000,         category = 'moto',       type = 'bike', shop = 'pdm' },
    { model = 'batic',          name = ' 801 Custom',                               brand = 'Bati',     price = 142000,         category = 'moto',       type = 'bike', shop = 'pdm' },
    { model = 'pcj',            name = ' 2007 Hornet Carburada',                    brand = 'Honda',    price = 82000,         category = 'moto',       type = 'bike', shop = 'pdm' },
    { model = 'hcbr17',         name = ' 2017 CBR1000RR/SP',                        brand = 'Honda',    price = 79000,         category = 'moto',       type = 'bike', shop = 'pdm' },
    { model = 'blazer3',        name = ' Banshee Graphics',                         brand = 'Monster',  price = 150000,         category = 'moto',       type = 'bike', shop = 'pdm' },
    { model = 'banshee87',      name = ' 1987 Banshee',                             brand = 'Yamaha',   price = 98000,         category = 'moto',       type = 'bike', shop = 'pdm' },
    { model = 'zoomerx',        name = ' ZoomerX-Custom',                           brand = 'Honda',    price = 83000,         category = 'moto',       type = 'bike', shop = 'pdm' },
    { model = 'kx250f',         name = ' 2016 KX250F',                              brand = 'Kawasaki', price = 115000,         category = 'moto',       type = 'bike', shop = 'pdm' },
    { model = 'sanchez',        name = ' KX - Monster Energy Limited Edition 2008', brand = 'Kawasaki', price = 108000,         category = 'moto',       type = 'bike', shop = 'pdm' },
    { model = 'yzf',            name = ' YZ250F - RedBull Graphics',                brand = 'Yamaha',   price = 94000,         category = 'moto',       type = 'bike', shop = 'pdm' },
    { model = 'yz450f',         name = ' 2015 YZ450F - Flúor Graphics',             brand = 'Yamaha',   price = 91000,         category = 'moto',       type = 'bike', shop = 'pdm' },
    { model = 'allnewnmax',     name = ' Nmax 155',                                 brand = 'Yamaha',   price = 97000,         category = 'moto',       type = 'bike', shop = 'pdm' },
    { model = 'tmax',           name = ' TMAX 500',                                 brand = 'Yamaha',   price = 99000,         category = 'moto',       type = 'bike', shop = 'pdm' },
    { model = 'zx10r',          name = ' Ninja Zx6r',                               brand = 'Kawasaki', price = 112000,         category = 'moto',       type = 'bike', shop = 'pdm' },
    { model = 'kr150',          name = ' KR 150',                                   brand = 'Kawasaki', price = 116000,         category = 'moto',       type = 'bike', shop = 'pdm' },
    { model = 'nh2r',           name = ' Ninja H2 & H2R',                           brand = 'Kawasaki', price = 118000,         category = 'moto',       type = 'bike', shop = 'pdm' },
    { model = 'ltr450',         name = ' 2009 LTR 450',                             brand = 'Suzuki',   price = 93000,         category = 'moto',       type = 'bike', shop = 'pdm' },
    { model = 'dl250',          name = ' 2017 DL250 V-Strom',                       brand = 'Suzuki',   price = 89000,         category = 'moto',       type = 'bike', shop = 'pdm' },
    { model = 'bmws',           name = ' S1000 RR 2014',                            brand = 'BMW',      price = 150000,         category = 'moto',       type = 'bike', shop = 'pdm' },
    { model = 'yz85',           name = ' 85cc',                                     brand = 'Yamaha',   price = 93000,         category = 'moto',       type = 'bike', shop = 'pdm' },
    { model = 'mt09',           name = ' MT-09 2017',                               brand = 'Yamaha',   price = 97000,         category = 'moto',       type = 'bike', shop = 'pdm' },
    { model = 'r1',             name = ' R1 2014',                                  brand = 'Yamaha',   price = 91000,         category = 'moto',       type = 'bike', shop = 'pdm' },
    { model = 'r6',             name = ' YZF R6 2017',                              brand = 'Yamaha',   price = 94000,         category = 'moto',       type = 'bike', shop = 'pdm' },

    -- Gendarmerie National
    { model = '_rtrafic15_gn',        name = '_rtrafic15_gn',  brand = 'GN',  price = 220000,         category = 'gendarmerie',       type = 'automobile', shop = 'pdm' },
    { model = 'dduster_gn',        name = 'dduster_gn',  brand = 'GN',  price = 220000,         category = 'gendarmerie',       type = 'automobile', shop = 'pdm' },
    { model = 'ffocus3sw_gn',        name = 'ffocus3sw_gn',  brand = 'GN',  price = 220000,         category = 'gendarmerie',       type = 'automobile', shop = 'pdm' },
    { model = 'idaily_gn',        name = 'idaily_gn',  brand = 'GN',  price = 220000,         category = 'gendarmerie',       type = 'automobile', shop = 'pdm' },
    { model = 'p5008_gn',        name = 'p5008_gn',  brand = 'GN',  price = 220000,         category = 'gendarmerie',       type = 'automobile', shop = 'pdm' },
    { model = 'pexpert12_gn',        name = 'pexpert12_gn',  brand = 'GN',  price = 220000,         category = 'gendarmerie',       type = 'automobile', shop = 'pdm' },
    { model = 'pexpert17_gn',        name = 'pexpert17_gn',  brand = 'GN',  price = 220000,         category = 'gendarmerie',       type = 'automobile', shop = 'pdm' },
    { model = 'ppartner12_gn',        name = 'ppartner12_gn',  brand = 'GN',  price = 220000,         category = 'gendarmerie',       type = 'automobile', shop = 'pdm' },
    { model = 'ppartner18_gn',        name = 'ppartner18_gn',  brand = 'GN',  price = 220000,         category = 'gendarmerie',       type = 'automobile', shop = 'pdm' },
    { model = 'prifter_gn',        name = 'prifter_gn',  brand = 'GN',  price = 220000,         category = 'gendarmerie',       type = 'automobile', shop = 'pdm' },
    { model = 'raa110_gn',        name = 'raa110_gn',  brand = 'GN',  price = 220000,         category = 'gendarmerie',       type = 'automobile', shop = 'pdm' },
    { model = 'rkangoo10_gn',        name = 'rkangoo10_gn',  brand = 'GN',  price = 220000,         category = 'gendarmerie',       type = 'automobile', shop = 'pdm' },
    { model = 'rmegane3e15_gn',        name = 'rmegane3e15_gn',  brand = 'GN',  price = 220000,         category = 'gendarmerie',       type = 'automobile', shop = 'pdm' },
    { model = 'rmegane3rs_gn',        name = 'rmegane3rs_gn',  brand = 'GN',  price = 220000,         category = 'gendarmerie',       type = 'automobile', shop = 'pdm' },
    { model = 'rmegane3rs_gn2',        name = 'rmegane3rs_gn2',  brand = 'GN',  price = 220000,         category = 'gendarmerie',       type = 'automobile', shop = 'pdm' },
    { model = 'rmegane3rs_gn3',        name = 'rmegane3rs_gn3',  brand = 'GN',  price = 220000,         category = 'gendarmerie',       type = 'automobile', shop = 'pdm' },
    { model = 'rmegane4e18_gn',        name = 'rmegane4e18_gn',  brand = 'GN',  price = 220000,         category = 'gendarmerie',       type = 'automobile', shop = 'pdm' },
    { model = 'rzoe_gn',        name = 'rzoe_gn',  brand = 'GN',  price = 220000,         category = 'gendarmerie',       type = 'automobile', shop = 'pdm' },
    { model = 'skodiaq_gn',        name = 'skodiaq_gn',  brand = 'GN',  price = 220000,         category = 'gendarmerie',       type = 'automobile', shop = 'pdm' },
    { model = 'sleoncupra_gn',        name = 'sleoncupra_gn',  brand = 'GN',  price = 220000,         category = 'gendarmerie',       type = 'automobile', shop = 'pdm' },
    { model = 'vegolf_gn',        name = 'vegolf_gn',  brand = 'GN',  price = 220000,         category = 'gendarmerie',       type = 'automobile', shop = 'pdm' },
    { model = 'ymt09t_gn',        name = 'ymt09t_gn',  brand = 'GN',  price = 220000,         category = 'gendarmerie',       type = 'automobile', shop = 'pdm' },
    { model = 'as350gn',        name = 'as350gn',  brand = 'GN',  price = 220000,         category = 'gendarmerie',       type = 'automobile', shop = 'pdm' },
    { model = 'b110',        name = 'b110',  brand = 'GN',  price = 220000,         category = 'gendarmerie',       type = 'automobile', shop = 'pdm' },
    { model = 'DRAP',        name = 'DRAP',  brand = 'GN',  price = 220000,         category = 'gendarmerie',       type = 'automobile', shop = 'pdm' },
    { model = 'ec145gn',        name = 'ec145gn',  brand = 'GN',  price = 220000,         category = 'gendarmerie',       type = 'automobile', shop = 'pdm' },
    { model = 'fjr1300gn',        name = 'fjr1300gn',  brand = 'GN',  price = 220000,         category = 'gendarmerie',       type = 'automobile', shop = 'pdm' },
    { model = 'vbrg',        name = 'vbrg',  brand = 'GN',  price = 220000,         category = 'gendarmerie',       type = 'automobile', shop = 'pdm' },
    { model = 'cberlingo_cyno-gn',        name = 'cberlingo_cyno-gn',  brand = 'GN',  price = 220000,         category = 'gendarmerie',       type = 'automobile', shop = 'pdm' },
    { model = 'franger_pghm-gn',        name = 'franger_pghm-gn',  brand = 'GN',  price = 220000,         category = 'gendarmerie',       type = 'automobile', shop = 'pdm' },
    { model = 'p508gt_ban-gn',        name = 'p508gt_ban-gn',  brand = 'GN',  price = 220000,         category = 'gendarmerie',       type = 'automobile', shop = 'pdm' },

    -- Pompier de paris
    { model = 'bsppccf',        name = 'bsppccf',  brand = 'Pompier',  price = 220000,         category = 'pompier',       type = 'automobile', shop = 'pdm' },
    { model = 'bsppccfl',        name = 'bsppccfl',  brand = 'Pompier',  price = 220000,         category = 'pompier',       type = 'automobile', shop = 'pdm' },
    { model = 'bsppfpt',        name = 'bsppfpt',  brand = 'Pompier',  price = 220000,         category = 'pompier',       type = 'automobile', shop = 'pdm' },
    { model = 'bsppfptl',        name = 'bsppfptl',  brand = 'Pompier',  price = 220000,         category = 'pompier',       type = 'automobile', shop = 'pdm' },
    { model = 'bsppgrimp',        name = 'bsppgrimp',  brand = 'Pompier',  price = 220000,         category = 'pompier',       type = 'automobile', shop = 'pdm' },
    { model = 'bsppmaster2',        name = 'bsppmaster2',  brand = 'Pompier',  price = 220000,         category = 'pompier',       type = 'automobile', shop = 'pdm' },
    { model = 'bsppmaster3',        name = 'bsppmaster3',  brand = 'Pompier',  price = 220000,         category = 'pompier',       type = 'automobile', shop = 'pdm' },
    { model = 'bsppmaster4',        name = 'bsppmaster4',  brand = 'Pompier',  price = 220000,         category = 'pompier',       type = 'automobile', shop = 'pdm' },
    { model = 'bspppc',        name = 'bspppc',  brand = 'Pompier',  price = 220000,         category = 'pompier',       type = 'automobile', shop = 'pdm' },
    { model = 'bsppps',        name = 'bsppps',  brand = 'Pompier',  price = 220000,         category = 'pompier',       type = 'automobile', shop = 'pdm' },
    { model = 'bsppvps',        name = 'bsppvps',  brand = 'Pompier',  price = 220000,         category = 'pompier',       type = 'automobile', shop = 'pdm' },

    -- Samu de Paris
    { model = '5008samu75',        name = '5008samu75',  brand = 'Samu',  price = 220000,         category = 'samu',       type = 'automobile', shop = 'pdm' },
    { model = 'ambulance',        name = 'ambulance',  brand = 'Samu',  price = 220000,         category = 'samu',       type = 'automobile', shop = 'pdm' },
    { model = 'bmwsamu75',        name = 'bmwsamu75',  brand = 'Samu',  price = 220000,         category = 'samu',       type = 'automobile', shop = 'pdm' },
    { model = 'ec135samu',        name = 'ec135samu',  brand = 'Samu',  price = 220000,         category = 'samu',       type = 'automobile', shop = 'pdm' },
    { model = 'pcmsamu',        name = 'pcmsamu',  brand = 'Samu',  price = 220000,         category = 'samu',       type = 'automobile', shop = 'pdm' },
    { model = 'rsb_mbsprinter',        name = 'rsb_mbsprinter',  brand = 'Samu',  price = 220000,         category = 'samu',       type = 'automobile', shop = 'pdm' },
    { model = 'sm3008',        name = 'sm3008',  brand = 'Samu',  price = 220000,         category = 'samu',       type = 'automobile', shop = 'pdm' },
    { model = 'smc3',        name = 'smc3',  brand = 'Samu',  price = 220000,         category = 'samu',       type = 'automobile', shop = 'pdm' },
    { model = 'smranger',        name = 'smranger',  brand = 'Samu',  price = 220000,         category = 'samu',       type = 'automobile', shop = 'pdm' },
    { model = 'smsprinter',        name = 'smsprinter',  brand = 'Samu',  price = 220000,         category = 'samu',       type = 'automobile', shop = 'pdm' },
    { model = 'umhnecker',        name = 'umhnecker',  brand = 'Samu',  price = 220000,         category = 'samu',       type = 'automobile', shop = 'pdm' },
    { model = 'vlm95',        name = 'vlm95',  brand = 'Samu',  price = 220000,         category = 'samu',       type = 'automobile', shop = 'pdm' },

    -- DIR
    { model = 'police3',        name = 'police3',  brand = 'DIR',  price = 220000,         category = 'dir',       type = 'automobile', shop = 'pdm' },
    { model = 'dir1',        name = 'dir1',  brand = 'DIR',  price = 220000,         category = 'dir',       type = 'automobile', shop = 'pdm' },
    { model = 'dir2',        name = 'dir2',  brand = 'DIR',  price = 220000,         category = 'dir',       type = 'automobile', shop = 'pdm' },
    { model = 'dir3',        name = 'dir3',  brand = 'DIR',  price = 220000,         category = 'dir',       type = 'automobile', shop = 'pdm' },
    { model = 'dir4',        name = 'dir4',  brand = 'DIR',  price = 220000,         category = 'dir',       type = 'automobile', shop = 'pdm' },
    { model = 'dir5',        name = 'dir5',  brand = 'DIR',  price = 220000,         category = 'dir',       type = 'automobile', shop = 'pdm' },
    { model = 'dir7',        name = 'dir7',  brand = 'DIR',  price = 220000,         category = 'dir',       type = 'automobile', shop = 'pdm' },
    { model = 'dir9',        name = 'dir9',  brand = 'DIR',  price = 220000,         category = 'dir',       type = 'automobile', shop = 'pdm' },
    { model = 'dir10',        name = 'dir10',  brand = 'DIR',  price = 220000,         category = 'dir',       type = 'automobile', shop = 'pdm' },
    ...
    { model = 'Fs_rapsnowvinci',        name = 'Fs_rapsnowvinci',  brand = 'Vinci',  price = 220000,         category = 'vinci',       type = 'automobile', shop = 'pdm' },
    { model = 'Fs_riftervinci',        name = 'Fs_riftervinci',  brand = 'Vinci',  price = 220000,         category = 'vinci',       type = 'automobile', shop = 'pdm' },
    { model = 'Fs_scaniavinci',        name = 'Fs_scaniavinci',  brand = 'Vinci',  price = 220000,         category = 'vinci',       type = 'automobile', shop = 'pdm' },
    { model = 'Fs_snowtruckvinci',        name = 'Fs_snowtruckvinci',  brand = 'Vinci',  price = 220000,         category = 'vinci',       type = 'automobile', shop = 'pdm' },
    { model = 'Fs_transitvinci',        name = 'Fs_transitvinci',  brand = 'Vinci',  price = 220000,         category = 'vinci',       type = 'automobile', shop = 'pdm' },
    ...
    { model = 'dduster_pn',        name = 'dduster_pn',  brand = 'PN',  price = 220000,         category = 'police_national',       type = 'automobile', shop = 'pdm' },
    { model = 'fcmax_crs',        name = 'fcmax_crs',  brand = 'PN',  price = 220000,         category = 'police_national',       type = 'automobile', shop = 'pdm' },
    { model = 'ffocus3sw_crs',        name = 'ffocus3sw_crs',  brand = 'PN',  price = 220000,         category = 'police_national',       type = 'automobile', shop = 'pdm' },
    { model = 'ffocus3sw_pn',        name = 'ffocus3sw_pn',  brand = 'PN',  price = 220000,         category = 'police_national',       type = 'automobile', shop = 'pdm' },
    { model = 'fmondeo09_bac75n',        name = 'fmondeo09_bac75n',  brand = 'PN',  price = 220000,         category = 'police_national',       type = 'automobile', shop = 'pdm' },
    { model = 'fmondeo17_bac75n1',        name = 'fmondeo17_bac75n1',  brand = 'PN',  price = 220000,         category = 'police_national',       type = 'automobile', shop = 'pdm' },
    { model = 'fmondeo17_bac75n2',        name = 'fmondeo17_bac75n2',  brand = 'PN',  price = 220000,         category = 'police_national',       type = 'automobile', shop = 'pdm' },
    { model = 'ftransit_crs',        name = 'ftransit_crs',  brand = 'PN',  price = 220000,         category = 'police_national',       type = 'automobile', shop = 'pdm' },
    { model = 'ftransit_pn',        name = 'ftransit_pn',  brand = 'PN',  price = 220000,         category = 'police_national',       type = 'automobile', shop = 'pdm' },
    { model = 'ntitus_bri',        name = 'ntitus_bri',  brand = 'PN',  price = 220000,         category = 'police_national',       type = 'automobile', shop = 'pdm' },
    { model = 'p308_pn',        name = 'p308_pn',  brand = 'PN',  price = 220000,         category = 'police_national',       type = 'automobile', shop = 'pdm' },
    { model = 'p508gt_ban-pn',        name = 'p508gt_ban-pn',  brand = 'PN',  price = 220000,         category = 'police_national',       type = 'automobile', shop = 'pdm' },
    { model = 'p308_pn',        name = 'p308_pn',  brand = 'PN',  price = 220000,         category = 'police_national',       type = 'automobile', shop = 'pdm' },
    { model = 'p508gt_ban-pn',        name = 'p508gt_ban-pn',  brand = 'PN',  price = 220000,         category = 'police_national',       type = 'automobile', shop = 'pdm' },
    { model = 'p508sw_bac75n',        name = 'p508sw_bac75n',  brand = 'PN',  price = 220000,         category = 'police_national',       type = 'automobile', shop = 'pdm' },
    { model = 'p3008_pn',        name = 'p3008_pn',  brand = 'PN',  price = 220000,         category = 'police_national',       type = 'automobile', shop = 'pdm' },
    { model = 'p5008_pn',        name = 'p5008_pn',  brand = 'PN',  price = 220000,         category = 'police_national',       type = 'automobile', shop = 'pdm' },
    { model = 'pexpert17_pn',        name = 'pexpert17_pn',  brand = 'PN',  price = 220000,         category = 'police_national',       type = 'automobile', shop = 'pdm' },
    { model = 'police2',        name = 'police2',  brand = 'PN',  price = 220000,         category = 'police_national',       type = 'automobile', shop = 'pdm' },
    { model = 'ppartner12_pn',        name = 'ppartner12_pn',  brand = 'PN',  price = 220000,         category = 'police_national',       type = 'automobile', shop = 'pdm' },
    { model = 'ppvp_bri',        name = 'ppvp_bri',  brand = 'PN',  price = 220000,         category = 'police_national',       type = 'automobile', shop = 'pdm' },
    { model = 'prifter_pn',        name = 'prifter_pn',  brand = 'PN',  price = 220000,         category = 'police_national',       type = 'automobile', shop = 'pdm' },
    { model = 'rmaster205_pn',        name = 'rmaster205_pn',  brand = 'PN',  price = 220000,         category = 'police_national',       type = 'automobile', shop = 'pdm' },
    { model = 'rmaster317_crs',        name = 'rmaster317_crs',  brand = 'PN',  price = 220000,         category = 'police_national',       type = 'automobile', shop = 'pdm' },
    { model = 'rmegane3e10_pn',        name = 'rmegane3e10_pn',  brand = 'PN',  price = 220000,         category = 'police_national',       type = 'automobile', shop = 'pdm' },
    { model = 'rmegane4e18_pn',        name = 'rmegane4e18_pn',  brand = 'PN',  price = 220000,         category = 'police_national',       type = 'automobile', shop = 'pdm' },
    { model = 'rscenic3_pn1',        name = 'rscenic3_pn1',  brand = 'PN',  price = 220000,         category = 'police_national',       type = 'automobile', shop = 'pdm' },
    { model = 'rscenic3_pn2',        name = 'rscenic3_pn2',  brand = 'PN',  price = 220000,         category = 'police_national',       type = 'automobile', shop = 'pdm' },
    { model = 'rscenic22_pn',        name = 'rscenic22_pn',  brand = 'PN',  price = 220000,         category = 'police_national',       type = 'automobile', shop = 'pdm' },
    { model = 'rtrafic15_crsa',        name = 'rtrafic15_crsa',  brand = 'PN',  price = 220000,         category = 'police_national',       type = 'automobile', shop = 'pdm' },
    { model = 'skodiaq_pn',        name = 'skodiaq_pn',  brand = 'PN',  price = 220000,         category = 'police_national',       type = 'automobile', shop = 'pdm' },
    { model = 'soctavia_bac75n',        name = 'soctavia_bac75n',  brand = 'PN',  price = 220000,         category = 'police_national',       type = 'automobile', shop = 'pdm' },
    { model = 'soctavia_pn',        name = 'soctavia_pn',  brand = 'PN',  price = 220000,         category = 'police_national',       type = 'automobile', shop = 'pdm' },
    { model = 'soctaviacombi_bac75n',        name = 'soctaviacombi_bac75n',  brand = 'PN',  price = 220000,         category = 'police_national',       type = 'automobile', shop = 'pdm' },
    { model = 'soctaviacombi_pn',        name = 'soctaviacombi_pn',  brand = 'PN',  price = 220000,         category = 'police_national',       type = 'automobile', shop = 'pdm' },
    { model = 'vpassatgte_bac75n',        name = 'vpassatgte_bac75n',  brand = 'PN',  price = 220000,         category = 'police_national',       type = 'automobile', shop = 'pdm' },
    { model = 'vpassatgtev_bac75n1',        name = 'vpassatgtev_bac75n1',  brand = 'PN',  price = 220000,         category = 'police_national',       type = 'automobile', shop = 'pdm' },
    { model = 'vpassatgtev_bac75n2',        name = 'vpassatgtev_bac75n2',  brand = 'PN',  price = 220000,         category = 'police_national',       type = 'automobile', shop = 'pdm' },
    { model = 'yfjr1300__pn',        name = 'yfjr1300__pn',  brand = 'PN',  price = 220000,         category = 'police_national',       type = 'automobile', shop = 'pdm' },
    { model = 'ymt09t_pn',        name = 'ymt09t_pn',  brand = 'PN',  price = 220000,         category = 'police_national',       type = 'automobile', shop = 'pdm' },
    { model = 'yxt1200zst_bri',        name = 'yxt1200zst_bri',  brasnd = 'PN',  price = 220000,         category = 'police_national',       type = 'automobile', shop = 'pdm' },
    { model = 'astrapn',        name = 'astrapn',  brand = 'PN',  price = 220000,         category = 'police_national',       type = 'automobile', shop = 'pdm' },
    { model = 'fordbac',        name = 'fordbac',  brand = 'PN',  price = 220000,         category = 'police_national',       type = 'automobile', shop = 'pdm' },
    { model = 'fordgn',        name = 'fordgn',  brand = 'PN',  price = 220000,         category = 'gendarmerie_nationale',       type = 'automobile', shop = 'pdm' },
    { model = 'mitsubishi_hi',        name = 'mitsubishi_hi',  brand = 'PN',  price = 220000,         category = 'police_national',       type = 'automobile', shop = 'pdm' },
    { model = 'mitsubishi',        name = 'mitsubishi',  brand = 'PN',  price = 220000,         category = 'police_national',       type = 'automobile', shop = 'pdm' },
    { model = 'motopn',        name = 'motopn',  brand = 'PN',  price = 220000,         category = 'police_national',       type = 'automobile', shop = 'pdm' },
    { model = 'policeold2',        name = 'policeold2',  brand = 'PN',  price = 220000,         category = 'police_national',       type = 'automobile', shop = 'pdm' },
    { model = 'polmav',        name = 'yfjr1300__pn',  brand = 'PN',  price = 220000,         category = 'police_national',       type = 'automobile', shop = 'pdm' },

    -- Raid
    { model = 'bearcat',        name = 'bearcat',  brand = 'RAID',  price = 220000,         category = 'raid',       type = 'automobile', shop = 'pdm' },

    -- Banaliser
    { model = '208bana',        name = '208bana',  brand = 'Banaliser',  price = 220000,         category = 'banaliser',       type = 'automobile', shop = 'pdm' },
    { model = '508bana',        name = '508bana',  brand = 'Banaliser',  price = 220000,         category = 'banaliser',       type = 'automobile', shop = 'pdm' },
    { model = '5008bana',        name = '5008bana',  brand = 'Banaliser',  price = 220000,         category = 'banaliser',       type = 'automobile', shop = 'pdm' },
    { model = '3082022bana',        name = '3082022bana',  brand = 'Banaliser',  price = 220000,         category = 'banaliser',       type = 'automobile', shop = 'pdm' },
    { model = 'c4bana',        name = 'c4bana',  brand = 'Banaliser',  price = 220000,         category = 'banaliser',       type = 'automobile', shop = 'pdm' },
    { model = 'megane3bana',        name = 'megane3bana',  brand = 'Banaliser',  price = 220000,         category = 'banaliser',       type = 'automobile', shop = 'pdm' },
    { model = 'passatbana',        name = 'passatbana',  brand = 'Banaliser',  price = 220000,         category = 'banaliser',       type = 'automobile', shop = 'pdm' },
    { model = 'tracer900bana',        name = 'tracer900bana',  brand = 'Banaliser',  price = 220000,         category = 'banaliser',       type = 'automobile', shop = 'pdm' },

    -- Chronopost
    { model = 'chrono1',        name = 'chrono1',  brand = 'Chronopost',  price = 220000,         category = 'chronopost',       type = 'automobile', shop = 'pdm' },
    { model = 'chrono2',        name = 'chrono2',  brand = 'Chronopost',  price = 220000,         category = 'chronopost',       type = 'automobile', shop = 'pdm' },
