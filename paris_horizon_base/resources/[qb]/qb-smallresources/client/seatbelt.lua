    ...
    while IsPedInAnyVehicle(ped, false) do
        ...
        if currVehicle and currVehicle ~= false and currVehicle ~= 0 then
            ...
            if frameBodyChange ~= 0 then
                if lastFrameVehSpeed > 60 and thisFrameVehSpeed < (lastFrameVehSpeed * 0.75) and not damageDone then
...
RegisterNetEvent('seatbelt:client:UseHarness', function(ItemData)
    QBCore.Functions.Notify("Le harnais n'est pas disponible", 'error')
end)
