...
Config.vehicleList = {
    ...
    { name = "faggio2", model = "faggio2", price = 100, needLicense = true },
    { name = "Golf", model = "blista", price = 500 , needLicense = true},
    { name = "twingo", model = "twingo", price = 500 , needLicense = true},
}

Config.locations = {
    {
        id = 1,
        spawnPed = vector4(-1025.23, -2732.57, 13.76, 62.35),
        spawns = {
            vector4(-1024.81, -2728.42, 13.67, 245.44),
    ...
    {
        id = 2,
        spawnPed = vector4(260.46, -638.58, 40.57, 68.49),
        spawns = {
