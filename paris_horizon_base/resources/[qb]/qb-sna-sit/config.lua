...
Config.Text = {
    StandUp = "[E] Se Lever",
    Occupied = "La chaise est utilisée.",
    TargetLabel = "Assieds-toi"
}
...
Config.Sitable = {
	...
	-- BENCH
	prop_bench_01a 				= { scenario = 'PROP_HUMAN_SEAT_BENCH', verticalOffset = 0.45, forwardOffset = 0.0, sideOffset = 0.0, rotationOffset = 0.0},
	...
	prop_bench_11 				= { scenario = 'PROP_HUMAN_SEAT_BENCH', verticalOffset = 0.4, forwardOffset = 0.0, sideOffset = 0.0, rotationOffset = 0.0},
	...
	hei_prop_hei_skid_chair 		= { scenario = 'PROP_HUMAN_SEAT_BENCH', verticalOffset = 0.1, forwardOffset = 0.0, sideOffset = 0.0, rotationOffset = 0.0},
	...
	prop_chair_08 				= { scenario = 'PROP_HUMAN_SEAT_BENCH', verticalOffset = 0.0, forwardOffset = 0.0, sideOffset = 0.0, rotationOffset = 0.0},
	...
	prop_skid_chair_01 			= { scenario = 'PROP_HUMAN_SEAT_BENCH', verticalOffset = 0.1, forwardOffset = 0.0, sideOffset = 0.0, rotationOffset = 0.0},
	prop_skid_chair_02 			= { scenario = 'PROP_HUMAN_SEAT_BENCH', verticalOffset = 0.1, forwardOffset = 0.0, sideOffset = 0.0, rotationOffset = 0.0},
	...
	prop_wheelchair_01 			= { scenario = 'PROP_HUMAN_SEAT_BENCH', verticalOffset = 0.0, forwardOffset = 0.0, sideOffset = 0.0, rotationOffset = 0.0},
	...
	prop_table_01_chr_a 			= { scenario = 'PROP_HUMAN_SEAT_BENCH', verticalOffset = 0.0, forwardOffset = 0.0, sideOffset = 0.0, rotationOffset = 0.0},
	...
	xm3_prop_xm3_folding_chair_01a			= { scenario = 'PROP_HUMAN_SEAT_BENCH', verticalOffset = 0.5, forwardOffset = -0.2, sideOffset = 0.0, rotationOffset = 0.0},
	...
	customchair01			= { hash = -606800174, scenario = 'PROP_HUMAN_SEAT_BENCH', verticalOffset = 0.5, forwardOffset = 0.1, sideOffset = 0.0, rotationOffset = 0.0},
	customchair02			= { hash = 536136906, scenario = 'PROP_HUMAN_SEAT_BENCH', verticalOffset = -0.1, forwardOffset = 0.1, sideOffset = 0.0, rotationOffset = 0.0},
