...
Config.DeathTime = 200                                       -- How long the timer is for players to bleed out completely and respawn at the hospital
Config.ReviveInterval = 240                                  -- How long the timer is for players to revive a player in laststand
Config.MinimumRevive = 200                                   -- How long the timer is for players to revive a player in laststand
...
Config.Locations = {                -- Edit the various interaction points for players or create new ones
    ...
    ['beds'] = {
        { coords = vector4(-1865.78, -332.09, 50.19, 140.27),    taken = false, model = 1631638868 },
        { coords = vector4(-1862.78, -334.35, 50.19, 221.02),  taken = false, model = 1631638868 },
        { coords = vector4(-1868.41, -329.78, 50.19, 200.9),   taken = false, model = 2117668672 },
        { coords = vector4(-1872.18, -326.99, 50.19, 252.84),    taken = false, model = 2117668672 },
        { coords = vector4(-1875.41, -324.62, 50.19, 166.11),   taken = false, model = 2117668672 },
        { coords = vector4(-1878.56, -321.89, 50.19, 53.92),  taken = false, model = -1091386327 },
        { coords = vector4(-1871.91, -320.59, 50.19, 356.45),  taken = false, model = -1091386327 },
        { coords = vector4(-1868.64, -323.19, 50.19, 78.4),  taken = false, model = -1091386327 },
    },
    ['jailbeds'] = {
    ...
    ['hospital'] = {
        {
            ...
            ['location'] = vector3(-1851.88, -337.1, 49.79),
            ['beds'] = {
                { coords = vector4(-1865.78, -332.09, 50.19, 140.27), taken = false, model = 1631638868 },
                { coords = vector4(-1862.78, -334.35, 50.19, 221.02), taken = false, model = 1631638868 },
                { coords = vector4(-1868.41, -329.78, 50.19, 200.9),  taken = false, model = 2117668672 },
        ...
        -- Commented out or removed Paleto hospital entry
        -- {
        --     ['name'] = Lang:t('info.paleto_hospital'),
        --     ['location'] = vector3(-254.54, 6331.78, 32.43), -- Example location
        --     ['beds'] = {
        --         -- Add bed coordinates here if needed
        --     },
        -- },
    },
    ['stations'] = {
        { label = "APHP Pitié Salpetriere", coords = vector3(-1866.3, -364.74, 51.05) }
    }
}
