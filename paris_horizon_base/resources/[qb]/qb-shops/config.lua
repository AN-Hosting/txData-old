...
Config.Products = {
    ...
    ['police'] = {
        ...
        { name = 'weapon_prolaser4',    price = 0, amount = 50 },
        ...
        { name = 'weapon_pepperspray',          price = 0, amount = 50 },
    },
    ['ambulance'] = {
        { name = 'radio',                   price = 0, amount = 50 },
    ...
    --     -- { name = 'cleaningkit',     price = 500, amount = 50 },

    --     { name = 'newoil', price = 0, amount = 50},
    --     { name = 'sparkplugs', price = 0, amount = 50},
    --     { name = 'carbattery', price = 0, amount = 50},
    --     { name = 'axleparts', price = 0, amount = 50},
    --     { name = 'sparetire', price = 0, amount = 50},
    --     { name = 'manual', price = 0, amount = 50},
    --     { name = 'underglow', price = 0, amount = 50},
    --     { name = 'underglow_controller', price = 0, amount = 50},
    --     { name = 'headlights', price = 0, amount = 50},
    --     { name = 'tint_supplies', price = 0, amount = 50},
    --     { name = 'customplate', price = 0, amount = 50},
    --     { name = 'hood', price = 0, amount = 50},
    --     { name = 'roof', price = 0, amount = 50},
    --     { name = 'spoiler', price = 0, amount = 50},
    --     { name = 'bumper', price = 0, amount = 50},
    --     { name = 'skirts', price = 0, amount = 50},
    --     { name = 'exhaust', price = 0, amount = 50},
    --     { name = 'seat', price = 0, amount = 50},
    --     { name = 'rollcage', price = 0, amount = 50},
    --     { name = 'rims', price = 0, amount = 50},
    --     { name = 'livery', price = 0, amount = 50},
    --     { name = 'paintcan', price = 0, amount = 50},
    --     { name = 'tires', price = 0, amount = 50},
    --     { name = 'horn', price = 0, amount = 50},
    --     { name = 'internals', price = 0, amount = 50},
    --     { name = 'externals', price = 0, amount = 50},
    --     { name = 'oilp1', price = 0, amount = 50},
    --     { name = 'oilp2', price = 0, amount = 50},
    --     { name = 'oilp3', price = 0, amount = 50},
    --     { name = 'drives1', price = 0, amount = 50},
    --     { name = 'drives2', price = 0, amount = 50},
    --     { name = 'drives3', price = 0, amount = 50},
    --     { name = 'cylind1', price = 0, amount = 50},
    --     { name = 'cylind2', price = 0, amount = 50},
    --     { name = 'cylind3', price = 0, amount = 50},
    --     { name = 'cables1', price = 0, amount = 50},
    --     { name = 'cables2', price = 0, amount = 50},
    --     { name = 'cables3', price = 0, amount = 50},
    --     { name = 'fueltank1', price = 0, amount = 50},
    --     { name = 'fueltank2', price = 0, amount = 50},
    --     { name = 'fueltank3', price = 0, amount = 50},
    --     { name = 'antilag', price = 0, amount = 50},
    --     { name = 'bprooftires', price = 0, amount = 50},
    --     { name = 'drifttires', price = 0, amount = 50},
    --     { name = 'turbo', price = 0, amount = 50},
    --     { name = 'car_armor', price = 0, amount = 50},
    --     { name = 'engine1', price = 0, amount = 50},
    --     { name = 'engine2', price = 0, amount = 50},
    --     { name = 'engine3', price = 0, amount = 50},
    --     { name = 'engine4', price = 0, amount = 50},
    --     { name = 'engine5', price = 0, amount = 50},
    --     { name = 'transmission1', price = 0, amount = 50},
    --     { name = 'transmission2', price = 0, amount = 50},
    --     { name = 'transmission3', price = 0, amount = 50},
    --     { name = 'transmission4', price = 0, amount = 50},
    --     { name = 'brakes1', price = 0, amount = 50},
    --     { name = 'brakes2', price = 0, amount = 50},
    --     { name = 'brakes3', price = 0, amount = 50},
    --     { name = 'suspension1', price = 0, amount = 50},
    --     { name = 'suspension2', price = 0, amount = 50},
    --     { name = 'suspension3', price = 0, amount = 50},
    --     { name = 'suspension4', price = 0, amount = 50},
    --     { name = 'suspension5', price = 0, amount = 50},
    --     { name = 'nos', price = 0, amount = 50},
    --     { name = 'noscan', price = 0, amount = 50},
    --     { name = 'noscolour', price = 0, amount = 50},
    --     { name = 'mechanic_tools', price = 0, amount = 50},
    --     { name = 'toolbox', price = 0, amount = 50},
    --     { name = 'ducttape', price = 0, amount = 50},
...
Config.Locations = { 
    ...
    ['ltdgasoline4'] = {
        ...
        ['blipscale'] = 0.4,
        ['blipcolor'] = 0,
        ['delivery'] = vector4(1160.42, -312.06, 69.28, 3.77)
    },
    ...
    ['gendarmerie_nationale'] = {
        ...
        ['coords'] = vector4(2487.4, -377.53, 82.69, 225.11),
        ['ped'] = 'mp_m_securoguard_01',
        ['scenario'] = 'WORLD_HUMAN_COP_IDLES',
        ['radius'] = 1.5,
        ['targetIcon'] = 'fas fa-gun',
        ['targetLabel'] = 'Armurerie',
        ['products'] = Config.Products['police'],
        ['delivery'] = vector4(2488.48, -378.39, 82.69, 45.5),
    ...
    ['blackmarket'] = {
        ['label'] = 'Black Market',
        ['coords'] = vector4(-594.7032, -1616.3647, 33.0105, 170.4846),
    ...
    ['phonestore2'] = {
        ['label'] = 'Magazin de Téléphone',
        ['coords'] = vector4(-1039.68, -2484.0, 20.34, 250.42),
        ['ped'] = 'a_m_y_beach_01',
        ['scenario'] = 'WORLD_HUMAN_STAND_IMPATIENT',
        ['radius'] = 1.5,
        ['targetIcon'] = 'fas fa-fish',
    ...
    ['samu_75'] = {
        ['label'] = 'Samu',
        ['coords'] = vector4(-1830.46, -381.36, 49.4, 61.85),
        ['ped'] = 'a_m_y_beach_01',
        ['scenario'] = 'WORLD_HUMAN_STAND_IMPATIENT',
        ['radius'] = 1.5,
        ['targetIcon'] = 'fas fa-fish',
        ...
        ['blipscale'] = 0.4,
        ['blipcolor'] = 0,
        ['delivery'] = vector4(-1830.46, -381.36, 49.4, 61.85),
    },
    ['pompiers_de_paris'] = {
        ['label'] = 'Pompier',
...
Config.Shops = {
    ['distributeur'] = {
        ...
        ['targetIcon'] = 'fas fa-shopping-cart',  -- vector4(-1830.46, -381.36, 49.4, 61.85)
